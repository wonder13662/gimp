...
불필요한 여백을 제거해서 원하는 크기로 맞추거나 대상을 강조하는 등의 이유로 이미지의 일정 부분을 잘라내 버리는 경우가 있습니다. 
...
#### 그림 3.4.5.1.1. 이미지 메뉴 바의 잘라내기 메뉴 위치
...
#### 그림 3.4.5.2.2. 이미지 메뉴 바(Image menu bar)의 도구 옵션(Tool Options) 메뉴
<img width="720" alt="그림 3.4.5.2.2. 이미지 메뉴 바(Image menu bar)의 도구 옵션(Tool Options) 메뉴" environment="MacOS:Sonoma 14.2.1 GIMP 2.10.36" src="https://github.com/wonder13662/gimp/assets/15767104/db5d23b6-d2c6-4292-92c8-7e1a495b3291">

도구 옵션의 `고정(Fixed)`의 `종횡비(Aspect ratio)`로 설정되어 있는지 확인해 주세요. 바로 아래의 입력창에 `1:1`과 같은 종횡비(Aspect ratio)를 입력할 수 있습니다.

#### 그림 3.4.5.2.1. 이미지 잘라내기 도구 옵션(종횡비 고정)
...
#### 그림 3.4.5.2.2. 이미지 잘라내기 도구 옵션(가로(landscape)모드, 세로(portrait)모드)
...
#### 그림 3.4.5.2.3. 새로운 종횡비 비율 적용 및 유지(가로모드에서 세로모드로 바꾸기)
