# 3.2.5.2.11. 자동으로 현재 이미지 따라가기(Auto Follow Active Image)
...
[➡️ 다음: 3.2.5.2.12. 화면으로 이동(Move to Screen)](./03-02-05-02-12-move_to_screen.md)

[⬅️ 이전: 3.2.5.2.10. 이미지 선택 표시(Show Image Selection)](./03-02-05-02-10-show_image_selection.md)
