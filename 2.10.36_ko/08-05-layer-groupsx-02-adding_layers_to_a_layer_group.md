...
(TODO 다른 어플리케이션 간섭으로 드래그 안되는 현상에 대해서 여기도 참조 필요. 이 문제는 별도 페이지로 빼는 것이 좋을 것 같다.)
