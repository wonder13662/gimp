...
#### 영상 14.1.4.7.a1. Alt(⌥) + 마우스 휠: 도구 옵션의 불투명도(Opacity) 조절
...
#### 영상 14.1.4.7.a2. Shift(⇧) + Ctrl(⌘) + 마우스 휠: 도구 옵션의 종횡비(Aspect Ratio) 조절
...
#### 영상 14.1.4.7.a3. Shift(⇧) + Alt(⌥) + 마우스 휠: 도구 옵션의 각도(Angle) 조절
...
#### 영상 14.1.4.7.a4. Ctrl(⌘) + Alt(⌥) + 마우스 휠: 도구 옵션의 크기(Size) 조절
...
#### 영상 14.1.4.7.a5. Shift(⇧) + Ctrl(⌘) + Alt(⌥) + 마우스 휠: 도구 옵션의 간격(Spacing) 조절
