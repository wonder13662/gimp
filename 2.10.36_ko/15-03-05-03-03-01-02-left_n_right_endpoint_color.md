# 15.3.5.3.3.1.2. 왼쪽과 오른쪽 끝점의 색(Left/Right Endpoint's Color)
...
`왼쪽 끝점의 색`과 `오른쪽 끝점의 색` 메뉴는 [색 타입 - 고정](./15-03-05-03-03-01-01-left_n_right_color_type.md#15-03-05-03-03-01-01-s1)일 때만 활성화됩니다.
