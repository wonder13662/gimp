# 15.5.2.2. 도구 프리셋 편집기 대화상자 사용하기(Using the Tool Preset Editor)
...
저장할 대상의 체크박스를 체크하고, 관련된 값을 설정한 뒤에 [프리셋 저장하기](./15-05-02-02-using_the_tool_preset_editor.md#15-05-02-02-s3-04) 버튼을 누르면 설정한 값이 도구 프리셋에 저장됩니다.
...
`프리셋 되돌리기` 버튼을 누르면, `도구 옵션`의 설정값 및 [저장할 대상](./15-05-02-02-using_the_tool_preset_editor.md#15-05-02-02-s3-03) 목록에서 체크한 대상들의 값이 도구 프리셋에 저장된 값으로 되돌려집니다.

다만 [저장할 대상](./15-05-02-02-using_the_tool_preset_editor.md#15-05-02-02-s3-03) 목록의 체크박스들이 이전 값으로 되돌려 지는 것은 아니라는 점을 유의해주세요.
