# 3.2.4.11. 내비게이션 (Navigation Control)

<a id="03-02-04-11-s1"></a>

## 1. 내비게이션의 위치

<a id="90-05-11-a101"></a>

#### [그림 90.5.11.a101. (11)내비게이션의 위치 (다중창)](./90-05-11-navigation_control.md#90-05-11-a101)
...
[이미지 창](./19-glossaryx-image_window.md)의 오른편 아래쪽에 있는 작은 화살표 모양의 버튼입니다.

<a id="03-02-04-11-s2"></a>

## 2. 내비게이션 미리보기로 이미지의 다른 부분으로 옮기기
마우스로 내비게이션 버튼을 클릭하여 누르고 있으면 내비게이션 미리 보기가 표시됩니다.

내비게이션 미리보기에는 전체 이미지 중에서 현재 화면에 표시되는 영역이 작은 상자로 표시됩니다. 

내비게이션 미리 보기에서 마우스 버튼을 누른 채 움직이면 [이미지](./19-glossaryx-image.md)의 다른 부분으로 이동할 수 있습니다. 

일부 밖에 표시되지 않는 큰 이미지의 경우 이런 방식을 통해 손쉽게 원하는 부분으로 이동할 수 있습니다.
...
<a id="03-02-04-11-s3"></a>

## 3. 내비게이션 창을 다른 방법으로 열기
내비게이션 창을 다른 방법으로 열고 싶다면 [15.2.6. 내비게이션 대화상자](./15-02-06-00-navigation-dialog.md)에 대한 설명을 참조해주세요. 

또한 마우스 가운데 버튼이 있다면, [이미지](./19-glossaryx-image.md) 위에서 가운데 버튼을 클릭한 후 드래그하여 원하는 부분으로 옮길수 있습니다.
