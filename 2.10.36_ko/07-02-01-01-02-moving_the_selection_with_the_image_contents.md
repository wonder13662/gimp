...
이 동작이 완료된 뒤에는 [떠있는 레이어(floating layer)](./16-04-05-00-float.md)가 만들어집니다. 떠있는 레이어는 [고정](./16-04-05-00-float.md)시키거나 [새로운 레이어](./16-07-02-00-new_layer.md)로 바꿔주어야 합니다.
