...
#### [그림 90.4.25.a132. 문서 이력 대화상자 → `탭 메뉴` → `문서 메뉴` → `이미지 열기` (Windows)](./90-04-0025-document_history.md#90-04-25-a132)
...
#### [영상 90.4.25.a132.1. 문서 이력 대화상자 → `탭 메뉴` → `문서 메뉴` → `이미지 열기` (Windows) (우리말)](./90-04-0025-document_history.md#90-04-25-a132-01)
...
#### [그림 90.4.25.a142. 문서 이력 대화상자 → `문서 이력 컨텍스트 메뉴` → `이미지 열기` (Windows)](./90-04-0025-document_history.md#90-04-25-a142)
...
#### [영상 90.4.25.a142.1. 문서 이력 대화상자 → `문서 이력 컨텍스트 메뉴` → `이미지 열기` (Windows) (우리말)](./90-04-0025-document_history.md#90-04-25-a142-01)
