...
모든 레이어는 레이어 대화상자에서 [레이어 섬네일](./15-02-01-02-02-03-layer_thumbnail.md) 형식으로 표시됩니다.
...
레이어 목록 위쪽의 영역에는 각 레이어의 [레이어 특성(레이어 모드, 불투명도, 잠금)](./15-02-01-02-03-00-layers_characteristics.md)을 제어할 수 있습니다.
