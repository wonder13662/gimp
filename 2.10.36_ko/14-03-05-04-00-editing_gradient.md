...
[➡️ 다음: 14.3.5.4.1. 캔버스에서 수정하기(On-canvas editing)](./14-03-05-04-01-on_canvas_editing.md)

[⬅️ 이전: 14.3.5.3.12. 활성화된 그라디언트 수정하기(Modify active gradient)](./14-03-05-03-12-modify_active_gradient.md)
