...
[16.6.11. 색상 프로파일로 변환(Convert to color profile) - 그림 90.1.5.3.a151](./16-06-11-00-convert-to-color-profile.md#90-01-05-03-a151)

[16.6.11.1. 명령 활성화하기(Activating the command) - 그림 90.1.5.3.a151](./16-06-11-01-activating_the_command.md#90-01-05-03-a151)

<a id="90-01-05-03-a151-01"></a>

#### 영상 90.1.5.3.a151.1. `이미지 메뉴 바` → `이미지` → `색상 관리` → `색상 프로파일로 변환` (Windows) (우리말)
...
[16.6.11.1. 명령 활성화하기(Activating the command) - 영상 90.1.5.3.a151.1](./16-06-11-01-activating_the_command.md#90-01-05-03-a151-01)
...
[16.6.12. 색상 프로파일 버리기(Discard color profile) - 그림 90.1.5.3.a161](./16-06-12-00-discard-color-profile.md#90-01-05-03-a161)

[16.6.12.1. 명령 활성화하기(Activating the command) - 그림 90.1.5.3.a161](./16-06-12-01-activating_the_command.md#90-01-05-03-a161)

<a id="90-01-05-03-a161-01"></a>

#### 영상 90.1.5.3.a161.1. `이미지 메뉴 바` → `이미지` → `색상 관리` → `색상 프로파일 버리기` (Windows) (우리말)
...
[16.6.12.1. 명령 활성화하기(Activating the command) - 영상 90.1.5.3.a161.1](./16-06-12-01-activating_the_command.md#90-01-05-03-a161-01)
...
[16.6.13. 색상 프로파일 파일로 저장하기(Save color profile to file) - 그림 90.1.5.3.a171](./16-06-13-00-save-color-profile-to-file.md#90-01-05-03-a171)

[16.6.13.1. 명령 활성화하기(Activating the command) - 그림 90.1.5.3.a171](./16-06-13-01-activating_the_command.md#90-01-05-03-a171)

<a id="90-01-05-03-a171-01"></a>

#### 영상 90.1.5.3.a171.1. `이미지 메뉴 바` → `이미지` → `색상 관리` → `색상 프로파일 파일로 저장하기` (Windows) (우리말)
...
[16.6.13.1. 명령 활성화하기(Activating the command) - 영상 90.1.5.3.a171.1](./16-06-13-01-activating_the_command.md#90-01-05-03-a171-01)
