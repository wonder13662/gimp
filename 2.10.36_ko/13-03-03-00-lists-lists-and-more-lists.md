...
이번 장에서는 `Scheme`의 리스트에 대해 알아보겠습니다.
...
[➡️ 다음: 13.3.3.1. 리스트 정의하기](./13-03-03-01-defining_a_list.md)

[⬅️ 이전: 13.3.2.6. 함수(Functions)](./13-03-02-06-functions.md)
...
[원문](https://docs.gimp.org/2.10/ko/gimp-using-script-fu-tutorial-lists.html)