...
아래와 같은 방법으로 `레이어 대화상자`를 활성화할 수 있습니다.
...
#### [그림 90.1.10.2.3.a101. `이미지 메뉴 바` → `창` → `도킹가능한 대화` → `레이어` (Windows)](./90-01-10-02-03-layers.md#90-01-10-02-03-a101)
...
[다른 운영체제와 언어의 `기본 설정` → `인터페이스` → `도구상자` → `모양새` → `GIMP 로고 보여주기` 확인하기](./90-01-10-02-03-layers.md#90-01-10-02-03-a102)

<a id="90-01-10-02-03-a101-01"></a>

#### [영상 90.1.10.2.3.a101.1. `이미지 메뉴 바` → `창` → `도킹가능한 대화` → `레이어` (Windows)](./90-01-10-02-03-layers.md#90-01-10-02-03-a101-01)
...
<a id="15-02-01-01-s4"></a>

## 4. 떼어낸 탭 대화상자 열기(Open Detached Dialog)

레이어 대화상자를 클릭, 드래그하여 별도의 레이어 대화상자로 떼어냈다면, `이미지 메뉴 바` → `창` → `레이어` 메뉴가 새로 생깁니다.

만약 별도의 레이어 대화상자가 보이지 않는다면, `이미지 메뉴 바` → `창` → `레이어` 메뉴를 클릭해서 가장 위로 올릴 수 있습니다.

<a id="90-01-10-02-03-a103"></a>

#### [영상 90.1.10.2.3.a103. `이미지 메뉴 바` → `창` → `레이어` (Windows)](./90-01-10-02-03-layers.md#90-01-10-02-03-a103)
...
[⬅️ 이전: 15.2.1. 레이어 대화상자(Layers dialog)](./15-02-01-00-layers_dialog.md)
