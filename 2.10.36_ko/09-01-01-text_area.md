...
## 7. 나중에 텍스트 수정하기
텍스트 레이어가 [레이어 대화상자](./15-02-01-00-layers_dialog.md)의 목록에 있고, 다른 도구로 수정되지 않았다면, 텍스트는 나중에 수정할 수 있습니다. 텍스트를 [레이어 대화상자](./15-02-01-00-layers_dialog.md)에서 활성화(선택)하고 텍스트 도구를 선택한 다음, 이미지 창(캔버스)에서 보이는 텍스트를 클릭하면 수정할 수 있습니다.
