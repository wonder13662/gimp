# 15.2.1.2.4.6. 레이어 합치기 또는 레이어 고정하기(Merge Layer or Anchor Layer)
...
#### [그림 90.4.3.8.a46. `레이어 대화상자` → `레이어 관리` → `레이어 합치기` (Windows) (우리말)](./90-04-0003-008-bottom_bar_buttons.md#90-04-03-08-a46)
...
레이어 그룹 안의 모든 [레이어](./19-glossaryx-layer.md)를 하나의 보통 레이어로 합칩니다.
...
[다른 운영체제와 언어의 `레이어 합치기` 대화상자 확인하기](./90-04-0056-merge_layers.md#90-04-56-a102)
...
`레이어 합치기` 대화상자를 열지 않고 모든 [보이는 레이어](./19-glossaryx-visible_layer.md)를 합칩니다.
...
## 2. 레이어 고정하기
[떠있는 선택](./19-glossaryx-floating_selection.md)이 있는 경우, `레이어 고정하기` 버튼을 누르면 이를 활성화된 레이어에 합치게 됩니다.
