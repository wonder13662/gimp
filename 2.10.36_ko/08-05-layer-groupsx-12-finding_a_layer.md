# 8.5.12. 레이어 찾기(Finding a layer)
많은 수의 레이어를 작업할 때, 목록에서 특정 레이어를 찾는 것은 쉽지 않습니다. GIMP(김프) 2.10.10 이후부터 캔버스에 직접 레이어를 선택하는 기능이 추가되었습니다. Alt(⌥)를 누른 채로 마우스 휠(Mouse Middle Button)로 클릭하면 엘리먼트의 레이어를 선택(활성화)할 수 있습니다.
...
## 다른 페이지로 가기
[➡️ 다음: 8.5.13. 레이어 미리보기(Layer preview)](./08-05-layer-groupsx-13-layer_preview.md)

[⬅️ 이전: 8.5.11. 레이어 마스크(Layer Mask)](./08-05-layer-groupsx-11-layer_mask.md)
