...
[15.3.6.4.1. 팔레트 편집기 활성화하기(How to Activate the Palette Editor) - 1. 팔레트 대화상자 → `탭 메뉴` → `팔레트 컨텍스트 메뉴` → `팔레트 편집` 메뉴 클릭](./15-03-06-04-01-how_to_activate_the_palette_editor.md#15-03-06-04-01-s1)을 참고해주세요.
