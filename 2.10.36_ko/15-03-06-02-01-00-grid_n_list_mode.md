# 15.3.6.2.1. 격자/목록 모드(Grid/List Mode)
...
[➡️ 다음: 15.3.6.2.1.1. 격자 모드(Grid Mode)](./15-03-06-02-01-01-grid_mode.md)

[⬅️ 이전: 15.3.6.2. 팔레트 대화상자 사용하기(Using the Palettes dialog)](./15-03-06-02-00-using_the_palettes_dialog.md)
