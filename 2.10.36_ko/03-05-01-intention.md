# 3.5.1. 목적
이 예제에서는 GIMP에서 직선을 그리는 방법을 소개합니다. 

직선을 이용하면, 마우스나 태블릿에 크게 영향받지 않으면서 상당히 깔끔하고 정돈되어 보이는 물체를 그릴 수 있습니다.

<a id="03-05-01-s1"></a>

## 1. 새 이미지 만들기
[`이미지 메뉴 바` → `파일` → `새 이미지`](./16-02-02-00-new.md) 메뉴를 클릭해 새로운 이미지 창을 만듭니다.
...
이번 예제에서는 [그리기 붓(Paintbrush)](./14-03-07-00-paintbrush.md)를 사용해보도록 하겠습니다.

<a id="03-05-01-s3"></a>

## 3. 시작점 만들기
[그리기 붓(Paintbrush)](./14-03-07-00-paintbrush.md)을 [도구상자](./14-01-00-the-toolbox.md)에서 클릭합니다. 

[이미지](./19-glossaryx-image.md) 안에 선이 시작하는 곳에 클릭합니다. 

점 하나가 화면에 나타납니다. 

점의 크기는 붓의 크기를 나타냅니다. 

붓의 크기는 [15.3.2. 붓 대화상자](./15-03-02-00-brushes_dialog.md)에서 바꿀 수 있습니다. 
...
## 4. 직선 그리기
시작점을 찍은 뒤 Shift(⇧) 키를 누르고 있으면, 마우스 커서를 따라서 위 화면과 같이 직선이 표시됩니다. 

이제 Shift(⇧) 키를 누른 상태로 마우스를 움직여 원하는 곳을 클릭합니다.
...
[칠하기 도구](./14-03-00-paint_tools.md)라면 직선을 그릴 수 있습니다. 

직선을 그린 뒤에 직선을 더 그릴 수도 있습니다. 

마지막으로 Shift(⇧) 키를 떼면 끝입니다. 

몇가지 예제들은 [3.5.2. 직선그리기 예제](./03-05-02-examples.md)에서 확인할 수 있습니다.
...
[➡️ 다음: 3.5.2. 직선그리기 예제](./03-05-02-examples.md)
