...
## 퀵마스크 수정하기
퀵마스크 모드에서의 이미지 수정은 이미지 자체가 아닌 선택 영역 채널에 영향을 미칩니다. 하얀색으로 칠하면 픽셀을 선택하게 되며, 검은색으로 칠하면 픽셀을 선택에서 제외합니다. 어떤 그리기 도구라도 이렇게 사용할 수 있습니다. 심지어 "영역 채우기(Bucket fill)"와 그라디언트 도구도 같은 방식으로 사용할 수 있습니다. GIMP(김프) 고급 사용자들은 "선택 영역 칠하기"가 가장 쉽고 효과적으로 이미지의 선택영역을 제어하는 방법이라는 것을 알고 있습니다.
