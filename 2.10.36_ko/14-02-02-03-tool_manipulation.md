...
이미지 위에 마우스 포인터를 클릭해서 드래그, 드랍으로 사각형 모양을 그릴 수 있습니다. 마우스 버튼을 놓으면, 선택 영역에 [점선(행진하는 개미) 외곽선](./19-glossaryx-marching_ants.md)이 생깁니다.
...
#### [그림 90.4.1.3.a161. `도구 옵션` → `사각 선택` → `강조` (Windows) (우리말)](./90-04-01-03-rectangle_select.md#90-04-01-03-a161)
