# 15.2.2.2.2. 채널 잠그기 속성(Channel Lock Attributes)

<a id="90-04-04-a11-03"></a>

#### [그림 90.4.4.a11.3. `채널 대화상자` → `채널 잠그기 버튼` (Windows) (우리말)](./90-04-0004-channels.md#90-04-04-a11-03)
...
#### [그림 90.4.4.a11.3.1. `채널 대화상자` → `채널 잠그기 버튼` → `픽셀 잠그기` (Windows) (우리말)](./90-04-0004-channels.md#90-04-04-a11-03-01)
...
그러므로 `선택 마스크 채널`에 [14.3. 칠하기 도구(Paint tools)](./14-03-00-paint_tools.md)로 작업할 수 없게 됩니다.

<a id="90-04-04-a11-03-01-01"></a>

#### [영상 90.4.4.a11.3.1.1. `채널 대화상자` → `채널 잠그기 버튼` → `픽셀 잠그기` (Windows) (우리말)](./90-04-0004-channels.md#90-04-04-a11-03-01-01)
...
#### [그림 90.4.4.a11.3.2. `채널 대화상자` → `채널 잠그기 버튼` → `위치와 크기 잠그기` (Windows) (우리말)](./90-04-0004-channels.md#90-04-04-a11-03-02)
...
#### [영상 90.4.4.a11.3.2.1. `채널 대화상자` → `채널 잠그기 버튼` → `위치와 크기 잠그기`: 변형 도구 (Windows) (우리말)](./90-04-0004-channels.md#90-04-04-a11-03-02-01)
...
#### [영상 90.4.4.a11.3.2.2. `채널 대화상자` → `채널 잠그기 버튼` → `위치와 크기 잠그기`: 이동 도구 사용불가 (Windows) (우리말)](./90-04-0004-channels.md#90-04-04-a11-03-02-02)
