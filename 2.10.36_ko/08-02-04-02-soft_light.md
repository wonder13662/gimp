...
`부드러운 조명(Soft light)` 모드는 [덧씌우기(Overlay)](./08-02-04-01-overlay.md) 모드와 비슷합니다. 하지만 `부드러운 조명(Soft light)` 모드는 [덧씌우기(Overlay)](./08-02-04-01-overlay.md) 모드에 비해 결과 이미지가 좀 더 부드럽고 색상이 덜 밝습니다.
