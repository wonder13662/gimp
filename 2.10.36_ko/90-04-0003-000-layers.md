...
#### 그림 90.4.3.a71.5. 여러 레이어를 가지고 있는 레이어 대화상자: 배경 레이어 (Windows) (우리말)
...
[8.1.1.2. 알파 채널(Alpha Channel) - 그림 90.4.3.a71.5](./08-01-01-02-alpha_channel.md#90-04-03-a71-05)

[19. 용어집 - 배경 레이어(Background Layer) - 그림 90.4.3.a71.5](./19-glossaryx-background_layer.md#90-04-03-a71-05)
...
[➡️ 다음: 90.4.3.1. 레이어 대화상자의 컨텍스트 메뉴](./90-04-0003-001-000-context_menu.md)

[⬅️ 이전: 90.4.2. 장치 상태(Device status)](./90-04-0002-device_status.md)
