...
#### 영상 3.2.1.1. 마우스 커서를 올려놓으면 도구의 설명이 보입니다
...
### 2. 전경색/배경색(Foreground color/Background color)
...
#### 영상 3.2.1.8. `Show GIMP logo(drag-and-drop target)`로 도구 상자에서 노출 제어하기
