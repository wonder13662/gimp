...
#### [그림 90.1.7.14.1.a1. `색` → `자동` → `평준화` (Windows)](./90-01-07-14-01-equalize.md#90-01-07-14-01-a1)
...
#### [그림 90.1.7.14.5.a1. `색` → `자동` → `색상 보강` (Windows)](./90-01-07-14-05-color_enhance.md#90-01-07-14-05-a1)
...
[다른 운영체제와 언어의 `색` → `자동` → `색상 보강` 확인하기](./90-01-07-14-05-color_enhance.md#90-01-07-14-05-a2)
...
#### [그림 90.1.7.14.3.a1. `색` → `자동` → `대비 증가...` (Windows)](./90-01-07-14-03-stretch_contrast.md#90-01-07-14-03-a1)
...
#### [그림 90.1.7.14.4.a1. `색` → `자동` → `HSV 대비 증가` (Windows)](./90-01-07-14-04-stretch_contrast_hsv.md#90-01-07-14-04-a1)
...
[다른 운영체제와 언어의 `색` → `자동` → `HSV 대비 증가` 확인하기](./90-01-07-14-04-stretch_contrast_hsv.md#90-01-07-14-04-a2)
...
#### [그림 90.1.7.14.2.a1. `색` → `자동` → `화이트 밸런스` (Windows)](./90-01-07-14-02-white_balance.md#90-01-07-14-02-a1)
