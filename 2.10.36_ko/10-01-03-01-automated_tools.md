...
#### [그림 90.1.7.14.1.a1. `색` → `자동` → `평준화` (Windows)](./90-01-07-colorsx-14-autox-01-equalize.md#90-01-07-14-01-a1)
...
[다른 운영체제와 언어의 `색` → `자동` → `평준화` 확인하기](./90-01-07-colorsx-14-autox-01-equalize.md#90-01-07-14-01-a2)
...
#### [영상 90.1.7.14.1.a3. `색` → `자동` → `평준화` (Windows) (우리말)](./90-01-07-colorsx-14-autox-01-equalize.md#90-01-07-14-01-a3)
...
#### [그림 90.1.7.14.5.a1. `색` → `자동` → `색상 보강` (Windows)](./90-01-07-colorsx-14-autox-05-color_enhance.md#90-01-07-14-05-a1)
...
[다른 운영체제와 언어의 `색` → `자동` → `색상 보강` 확인하기](./90-01-07-colorsx-14-autox-05-color_enhance.md#90-01-07-14-05-a2)
...
#### [그림 90.1.7.14.5.a4. 색상 보강 사용 전후 비교](./90-01-07-colorsx-14-autox-05-color_enhance.md#90-01-07-14-05-a4)
...
#### [영상 90.1.7.14.5.a3. `색` → `자동` → `색상 보강` (Windows) (우리말)](./90-01-07-colorsx-14-autox-05-color_enhance.md#90-01-07-14-05-a3)
...
#### [그림 90.1.7.14.3.a1. `색` → `자동` → `대비 증가...` (Windows)](./90-01-07-colorsx-14-autox-03-stretch_contrast.md#90-01-07-14-03-a1)
...
[다른 운영체제와 언어의 `색` → `자동` → `대비 증가...` 확인하기](./90-01-07-colorsx-14-autox-03-stretch_contrast.md#90-01-07-14-03-a2)
...
#### [그림 90.1.7.14.3.a4. 대비 증가 적용 전후 비교](./90-01-07-colorsx-14-autox-03-stretch_contrast.md#90-01-07-14-03-a4)
...
#### [영상 90.1.7.14.3.a5. `색` → `자동` → `대비 증가...` (Windows) (우리말)](./90-01-07-colorsx-14-autox-03-stretch_contrast.md#90-01-07-14-03-a5)
...
#### [그림 90.1.7.14.4.a1. `색` → `자동` → `HSV 대비 증가` (Windows)](./90-01-07-colorsx-14-autox-04-stretch_contrast_hsv.md#90-01-07-14-04-a1)
...
[다른 운영체제와 언어의 `색` → `자동` → `HSV 대비 증가` 확인하기](./90-01-07-colorsx-14-autox-04-stretch_contrast_hsv.md#90-01-07-14-04-a2)
...
#### [그림 90.1.7.14.4.a3. HSV 대비 증가 사용 전후 비교](./90-01-07-colorsx-14-autox-04-stretch_contrast_hsv.md#90-01-07-14-04-a3)
...
#### [영상 90.1.7.14.4.a4. `색` → `자동` → `HSV 대비 증가` (Windows) (우리말)](./90-01-07-colorsx-14-autox-04-stretch_contrast_hsv.md#90-01-07-14-04-a4)
...
#### [그림 90.1.7.14.2.a1. `색` → `자동` → `화이트 밸런스` (Windows)](./90-01-07-colorsx-14-autox-02-white_balance.md#90-01-07-14-02-a1)
...
[다른 운영체제와 언어의 `색` → `자동` → `화이트 밸런스` 확인하기](./90-01-07-colorsx-14-autox-02-white_balance.md#90-01-07-14-02-a2)

`화이트 밸런스(White balance)`는 거의 사용되지 않는 색을 제거해서 흰색이나 검정색이 부족한 이미지를 보기 좋게 만들어줍니다.

<a id="90-01-07-14-02-a3"></a>

#### [그림 90.1.7.14.2.a3. 화이트 밸런스 적용 전후 비교](./90-01-07-colorsx-14-autox-02-white_balance.md#90-01-07-14-02-a3)
...
#### [영상 90.1.7.14.2.a4. `색` → `자동` → `화이트 밸런스` (Windows) (우리말)](./90-01-07-colorsx-14-autox-02-white_balance.md#90-01-07-14-02-a4)
...
#### [그림 90.4.72.a111. `레벨` 대화상자 → `입력 레벨 자동화` (Windows) (우리말)](./90-04-72-level.md#90-04-72-a111)
...
#### [그림 90.4.72.a131. `레벨` 대화상자 → 모든 채널에 대한 검정색 점 고르기(Pick black point for all channels) (Windows) (우리말)](./90-04-72-level.md#90-04-72-a131)
...
#### [그림 90.4.72.a133. `레벨` 대화상자 → 모든 채널에 대한 하얀색 점 고르기(Pick white point for all channels) (Windows) (우리말)](./90-04-72-level.md#90-04-72-a133)
