...
'마이페인트 붓' 대화상자의 가장 위쪽에 [`필터 입력창`](./15-03-07-01-filter_field.md)이 있습니다. 

[`필터 입력창`](./15-03-07-01-filter_field.md)에 태그를 입력하면, 태그를 가지고 있는 마이페인트 붓만 노출됩니다.
...
#### [그림 90.4.17.a101.2.3. '마이페인트 붓' 대화상자: 격자 모드 → `태그 입력창` (Windows) (우리말)](./90-04-0017-mypaint_brushes.md#90-04-17-a101-02-03)
...
마이페인트 붓 목록의 아래의 [`태그 입력창`](./15-03-07-02-enter_tag_field.md)에 활성화 마이페인트 붓의 `태그`가 표시됩니다.

<a id="90-04-17-a101-02-03-01"></a>

#### [영상 90.4.17.a101.2.3.1. '마이페인트 붓' 대화상자: 격자 모드 → `태그 입력창` (Windows) (우리말)](./90-04-0017-mypaint_brushes.md#90-04-17-a101-02-03-01)
