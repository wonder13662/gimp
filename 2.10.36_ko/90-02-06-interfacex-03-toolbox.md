...
#### [그림 3.2.1.1. `GIMP`→ `기본 설정` → `인터페이스` → `도구 상자` → `모양새`](https://wonder13662.github.io/gimp/2.10.36_ko/03-02-01-the-toolbox.html#%EA%B7%B8%EB%A6%BC-3211-gimp-%EA%B8%B0%EB%B3%B8-%EC%84%A4%EC%A0%95--%EC%9D%B8%ED%84%B0%ED%8E%98%EC%9D%B4%EC%8A%A4--%EB%8F%84%EA%B5%AC-%EC%83%81%EC%9E%90--%EB%AA%A8%EC%96%91%EC%83%88)
[<img width="699" alt="기본설정-기본도구상자-모양새" environment="MacOS:Sonoma 14.2.1 GIMP 2.10.36" src="https://github.com/wonder13662/gimp/assets/15767104/bbc345c3-c339-4c2b-b099-2c7f0dfc2029">](https://wonder13662.github.io/gimp/2.10.36_ko/03-02-01-the-toolbox.html#%EA%B7%B8%EB%A6%BC-3211-gimp-%EA%B8%B0%EB%B3%B8-%EC%84%A4%EC%A0%95--%EC%9D%B8%ED%84%B0%ED%8E%98%EC%9D%B4%EC%8A%A4--%EB%8F%84%EA%B5%AC-%EC%83%81%EC%9E%90--%EB%AA%A8%EC%96%91%EC%83%88)

#### [그림 3.2.1.2. `GIMP`→ `Settings...` → `Interface` → `Toolbox` → `Appearance`](https://wonder13662.github.io/gimp/2.10.36_ko/03-02-01-the-toolbox.html#%EA%B7%B8%EB%A6%BC-3212-gimp-settings--interface--toolbox--appearance)
[<img width="699" alt="settings-toolbox" environment="MacOS:Sonoma 14.2.1 GIMP 2.10.36" src="https://github.com/wonder13662/gimp/assets/15767104/31f89128-f1e9-4cb0-8045-719b4a121a15">](https://wonder13662.github.io/gimp/2.10.36_ko/03-02-01-the-toolbox.html#%EA%B7%B8%EB%A6%BC-3212-gimp-settings--interface--toolbox--appearance)

#### [영상 3.2.1.3. `모양새(Appearance)`에서 아이콘 추가하기](https://wonder13662.github.io/gimp/2.10.36_ko/03-02-01-the-toolbox.html#%EC%98%81%EC%83%81-3213-%EB%AA%A8%EC%96%91%EC%83%88appearance%EC%97%90%EC%84%9C-%EC%95%84%EC%9D%B4%EC%BD%98-%EC%B6%94%EA%B0%80%ED%95%98%EA%B8%B0)
...
#### [그림 3.2.1.5. `GIMP`→ `기본 설정` → `인터페이스` → `도구 상자` → `모양새` → `Show GIMP logo(drag-and-drop target)`](https://wonder13662.github.io/gimp/2.10.36_ko/03-02-01-the-toolbox.html#%EA%B7%B8%EB%A6%BC-3215-gimp-%EA%B8%B0%EB%B3%B8-%EC%84%A4%EC%A0%95--%EC%9D%B8%ED%84%B0%ED%8E%98%EC%9D%B4%EC%8A%A4--%EB%8F%84%EA%B5%AC-%EC%83%81%EC%9E%90--%EB%AA%A8%EC%96%91%EC%83%88--show-gimp-logodrag-and-drop-target)
[<img width="699" alt="모양새-로고" src="https://github.com/wonder13662/gimp/assets/15767104/6800ff59-5dcf-4c11-8551-d95f2cee0f25">](https://wonder13662.github.io/gimp/2.10.36_ko/03-02-01-the-toolbox.html#%EA%B7%B8%EB%A6%BC-3215-gimp-%EA%B8%B0%EB%B3%B8-%EC%84%A4%EC%A0%95--%EC%9D%B8%ED%84%B0%ED%8E%98%EC%9D%B4%EC%8A%A4--%EB%8F%84%EA%B5%AC-%EC%83%81%EC%9E%90--%EB%AA%A8%EC%96%91%EC%83%88--show-gimp-logodrag-and-drop-target)

#### [그림 3.2.1.6. `GIMP`→ `Settings...` → `Interface` → `Toolbox` → `Appearance` → `Show GIMP logo(drag-and-drop target)`](https://wonder13662.github.io/gimp/2.10.36_ko/03-02-01-the-toolbox.html#%EA%B7%B8%EB%A6%BC-3216-gimp-settings--interface--toolbox--appearance--show-gimp-logodrag-and-drop-target)
[<img width="699" alt="show-gimp-logo" src="https://github.com/wonder13662/gimp/assets/15767104/4229eea9-896d-47d5-81ca-0ccbd42e8151">](https://wonder13662.github.io/gimp/2.10.36_ko/03-02-01-the-toolbox.html#%EA%B7%B8%EB%A6%BC-3216-gimp-settings--interface--toolbox--appearance--show-gimp-logodrag-and-drop-target)
