...
#### [그림 90.4.5.a141.4. `경로 대화상자` → `경로 연결고리` (windows) (우리말)](./90-04-05-paths.md#90-04-05-a141-04)
...
`경로 연결고리(Chain Paths)` 아이콘은 `경로 가시성(Path Visibility)` - 눈 아이콘 옆에 있습니다.
...
#### [영상 90.4.5.a141.4.1. `경로 대화상자` → `경로 연결고리` (windows) (우리말)](./90-04-05-paths.md#90-04-05-a141-04-01)
