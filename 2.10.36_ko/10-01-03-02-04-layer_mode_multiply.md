...
색칠을 할 때는 부드러운 [그라디언트](./14-03-05-00-gradient.md)만을 사용해야 합니다. [그리기 붓](./14-03-07-paintbrush.md) 등으로 색칠을 하게 되면, 증가값(gain)의 갑작스러운 변화로 이미지에 부자연스러운 경계를 만들어 낼 수도 있습니다. 아래 영상에서 [그리기 붓](./14-03-07-paintbrush.md)과 [그라디언트](./14-03-05-00-gradient.md)의 차이를 확인해보세요.
