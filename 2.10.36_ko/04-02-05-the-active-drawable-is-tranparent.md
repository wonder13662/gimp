...
## 1. 문제 확인
레이어의 불투명도(Opacity)가 0이라면, 그리는 것을 아무것도 볼 수 없습니다. [레이어 대화상자](./15-02-01-00-layers_dialog.md)의 위쪽의 `불투명(Opacity)` 슬라이더의 값이 슬라이더의 값이 0 또는 매우 낮은 값이 아닌지 확인해 보세요. 

<a id="90-04-03-04-a11"></a>

#### [그림 90.4.3.4.a11. 레이어의 불투명도가 0인 경우](./90-04-0003-004-opacity.md#90-04-03-04-a11)
...
#### [영상 90.4.3.4.a21. 레이어 불투명도 0인 상태에서 붓 그리기](./90-04-0003-004-opacity.md#90-04-03-04-a21)
...
#### [영상 90.4.3.4.a31. 레이어 불투명도 0에서 100으로 바꾸기](./90-04-0003-004-opacity.md#90-04-03-04-a31)
