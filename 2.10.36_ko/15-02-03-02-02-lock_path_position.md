# 15.2.3.2.2. 경로 위치 잠그기(Lock Path Position)

<a id="90-04-05-a141-02"></a>

#### [그림 90.4.5.a141.2. `경로 대화상자` → `경로 위치 잠그기` (windows) (우리말)](./90-04-05-paths.md#90-04-05-a141-02)
...
#### [그림 90.4.5.a141.2.1.1. `경로 대화상자` → `경로 위치 잠그기`: 잠긴 상태 (windows) (우리말)](./90-04-05-paths.md#90-04-05-a141-02-01-01)
...
#### [그림 90.4.5.a141.2.1.2. `경로 대화상자` → `경로 위치 잠그기`: 열린 상태 (windows) (우리말)](./90-04-05-paths.md#90-04-05-a141-02-01-02)
...
#### [영상 90.4.5.a141.2.2. `경로 대화상자` → `경로 위치 잠그기` (windows) (우리말)](./90-04-05-paths.md#90-04-05-a141-02-02)
...
#### [영상 90.4.5.a141.2.3. `경로 대화상자` → `경로 잠그기`, `경로 위치 잠그기`: (오류)두 잠금 중 하나라도 활성화되면 모든 경로 수정을 잠금 (windows) (우리말)](./90-04-05-paths.md#90-04-05-a141-02-03)
