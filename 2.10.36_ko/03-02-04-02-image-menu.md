...
[이미지 메뉴 바](./19-glossaryx-image_menu_bar.md)는 일부러 없애지 않는다면, [제목 표시줄](./19-glossaryx-title_bar.md) 바로 아래에 위치합니다.
...
[단일창](./19-glossaryx-single_window_mode.md)에서 [이미지 메뉴 바](./19-glossaryx-image_menu_bar.md)는 [이미지 창](./19-glossaryx-image_window.md)의 내부가 아닌 화면 최상단에 있습니다.
...
[다중창](./19-glossaryx-multi_window_mode.md)에서 [이미지 메뉴 바](./19-glossaryx-image_menu_bar.md)는 [이미지 창](./19-glossaryx-image_window.md)의 내부가 아닌 화면 최상단에 있습니다.
...
[이미지](./19-glossaryx-image.md) 안에서 마우스 오른쪽 버튼을 클릭하거나 [이미지 창](./19-glossaryx-image_window.md)의 왼쪽 상단 구석에 있는 메뉴 버튼(Menu Button)이라고 부르는 "화살표"를 클릭해서 이미지 메뉴를 사용할 수도 있습니다.
...
<a comment="TODO Windows 환경 재현 영상도 추가 필요"></a>
...
<a comment="TODO '동적 키보드 단축키 사용' 링크 연동하기"></a>
