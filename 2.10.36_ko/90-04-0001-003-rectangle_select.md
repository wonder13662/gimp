...
[19. 용어집 - 행진하는 개미(Marching Ants)](./19-glossaryx-marching_ants.md#90-04-01-03-a131)
...
#### 그림 90.4.1.3.a141.1. `도구 옵션` 대화상자 → 아래쪽 4개 버튼 → `저장하기`
...
#### 그림 90.4.1.3.a141.2. `도구 옵션` 대화상자 → 아래쪽 4개 버튼 → `불러오기`
...
#### 그림 90.4.1.3.a141.3. `도구 옵션` 대화상자 → 아래쪽 4개 버튼 → `삭제하기`
...
[➡️ 다음: 90.4.1.4. 타원 선택(Ellipse Select)](./90-04-0001-004-ellipse_select.md)

[⬅️ 이전: 90.4.1.2. 정렬(Alignment)](./90-04-0001-002-alignment.md)
