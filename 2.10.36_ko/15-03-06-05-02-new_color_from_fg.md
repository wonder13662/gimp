# 15.3.6.5.2. 전경색에서 가져오기(New Color from FG)

***

## 다른 페이지로 가기

[➡️ 다음: 15.3.6.5.3. 배경색에서 가져오기(New Color from BG)](./15-03-06-05-03-new_color_from_bg.md)

[⬅️ 이전: 15.3.6.5.1. 색상 편집(Edit Color)](./15-03-06-05-01-edit_color.md)
