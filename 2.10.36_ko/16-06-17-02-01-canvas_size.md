...
#### [그림 90.4.185.a130. `캔버스 크기 지정` 대화상자 → `캔버스 크기`(Windows) (우리말)](./90-04-0185-set_image_canvas_size.md#90-04-185-a130)
...
그리고 현재 [해상도](./19-glossaryx-resolution.md)가 함께 표시됩니다.
...
해상도를 바꾸고 싶다면, [인쇄크기 대화상자](./16-06-20-00-print-size.md)를 사용해주세요.

***

## 다른 페이지로 가기

[➡️ 다음: 16.6.17.2.2. 오프셋(Offset)](./16-06-17-02-02-00-offset.md)

[⬅️ 이전: 16.6.17.2. `캔버스 크기 지정` 대화상자 설명(Description of the “Set Image Canvas Size” dialog)](./16-06-17-02-00-description_of_the_set_image_canvas_size_dialog.md)
