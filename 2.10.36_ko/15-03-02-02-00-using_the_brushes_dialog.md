# 15.3.2.2. 붓 대화상자 사용하기(Using the Brushes Dialog)
...
[15.3.2.2.5.1. 붓 파일 경로 복사하기(Copy Brush Location)](./15-03-02-02-05-01-copy_brush_location.md)

[15.3.2.2.5.2. 파일 관리자에서 보기(Show in File Manager)](./15-03-02-02-05-02-show_in_file_manager.md)

***

## 다른 페이지로 가기

[➡️ 다음: 15.3.2.2.1. 격자/목록 모드(Grid/List mode)](./15-03-02-02-01-00-grid_n_list_mode.md)
...
[원문](https://docs.gimp.org/2.10/ko/gimp-brush-dialog.html#gimp-brush-dialog-using)