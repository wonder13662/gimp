...
#### 그림 14.3.2.5.a150.1. 조건 설정 과정 - 크기 곡선 조정
(TODO 곡선 조정 이미지 추가 - Image 5 + Image 6)

#### 영상 14.3.2.5.a150.2. 조건 설정 과정 - 크기 곡선 조정

붓의 크기와 색 둘다 `점차 사라짐(Fade)` 옵션의 곡선에 연결되어 위 이미지의 도표처럼 설정되었습니다.

#### 그림 14.3.2.5.a150.3. 붓의 스트로크 결과
(TODO 스트로크 이미지 추가)

#### 영상 14.3.2.5.a150.4. 붓의 스트로크 과정
