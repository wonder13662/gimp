# 14.5.6.3.1.5. 수직으로 오른쪽에서 왼쪽(수직 방향) - Vertical, right to left(upright orientation)
...
#### [그림 90.4.65.a141.1. `김프 텍스트 편집기` 대화상자 → `수직으로 오른쪽에서 왼쪽(수직 방향)`: 예시 이미지](./90-04-0065-gimp_text_editor.md#90-04-65-a141-01)
