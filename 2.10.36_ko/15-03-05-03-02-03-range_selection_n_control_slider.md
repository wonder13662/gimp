...
이 줄 위에서 끝점(검은색 삼각형)과 중간점(하얀색 삼각형)을 조정해서 `그라디언트 미리보기 창`에서 보여지는 결과를 수정할 수 있습니다.
...
#### [그림 90.4.139.a113.1. `그라디언트 편집기` 대화상자 → `범위 선택과 제어 슬라이더` → `마디` (Windows) (우리말)](./90-04-0139-gradient_editor.md#90-04-139-a113-01)
...
`마디(Segment)`는 끝점(검은색 삼각형) 사이의 공간입니다.

각 `마디(Segment)`의 안에는 중간점(하얀색 삼각형)이 있습니다.

이 중간점(하얀색 삼각형)을 기준으로 `마디(Segment)`의 색이 왼쪽 색상에서 오른쪽 색상으로 변하게 됩니다.

<a id="15-03-05-03-02-03-s2"></a>

## 2. 마디(Segment) 선택하기

`마디(Segment)`를 선택하려면 두 검은 삼각형 사이를 클릭하면 됩니다.

선택된 `마디(Segment)`는 하얀색으로 바뀝니다.

<a id="90-04-139-a113-02"></a>

#### [영상 90.4.139.a113.2. `그라디언트 편집기` 대화상자 → `범위 선택과 제어 슬라이더` → `마디`: 마디 선택하기 (Windows) (우리말)](./90-04-0139-gradient_editor.md#90-04-139-a113-02)
...
## 3. 여러 개의 마디(Segment) 선택

여러 개의 `마디(Segment)`를 선택하기 위해서는 Shift(⇧)를 누른채로 `마디(Segment)`를 클릭하면 선택에 추가됩니다.

선택된 범위는 연결되어 있는 연속된 `마디(Segment)`여야 합니다. 

연속되지 않은 마디를 선택하면, 사이의 선택되지 않은 마디도 자동으로 포함됩니다.

<a id="90-04-139-a113-03"></a>

#### [영상 90.4.139.a113.3. `그라디언트 편집기` 대화상자 → `범위 선택과 제어 슬라이더` → `마디`: 여러 개의 마디 선택 (Windows) (우리말)](./90-04-0139-gradient_editor.md#90-04-139-a113-03)
...
## 4. 제어 객체 옮기기
끝점(검은색 삼각형), 중간점(하얀색 삼각형), 마디, 그리고 선택을 옮길 수 있습니다.

<a id="15-03-05-03-02-03-s4-01"></a>

### 4-1. 끝점(검은색 삼각형), 중간점(하얀색 삼각형) 옮기기
끝점(검은색 삼각형), 중간점(하얀색 삼각형) 옮기면 관련된 부분만 옮겨지게 됩니다.

<a id="90-04-139-a114"></a>

#### [영상 90.4.139.a114. `그라디언트 편집기` 대화상자 → `범위 선택과 제어 슬라이더` → `제어 객체 옮기기`: 끝점(검은색 삼각형), 중간점(하얀색 삼각형) 옮기기 (Windows) (우리말)](./90-04-0139-gradient_editor.md#90-04-139-a114)
...
### 4-2. 마디(Segment) 옮기기
마디(Segment)를 클릭, 드래그하면 다음 끝점(검은색 삼각형)까지 옮길 수 있습니다.

<a id="90-04-139-a115"></a>

#### [영상 90.4.139.a115. `그라디언트 편집기` 대화상자 → `범위 선택과 제어 슬라이더` → `제어 객체 옮기기`: 마디 옮기기 (Windows) (우리말)](./90-04-0139-gradient_editor.md#90-04-139-a115)
...
Shift(⇧) 키를 누른 채로 마디와 선택을 클릭, 드래그하면 연결되어 있는 다른 마디들의 색 변화 비율의 비례가 유지되면서 옮길 수 있습니다.
