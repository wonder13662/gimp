...
#### 그림 90.1.6.1.a1. `이미지 메뉴 바` → `레이어` → `새 레이어`
...
[16.7.2. 새 레이어(New layer) - 그림 90.1.6.1.a1](./16-07-02-00-new_layer.md#90-01-06-01-a1)

<a id="90-01-06-01-a1-01"></a>

#### 영상 90.1.6.1.a1.1. `이미지 메뉴 바` → `레이어` → `새 레이어` (Windows) (우리말)
...
[16.7.2. 새 레이어(New layer) - 영상 90.1.6.1.a1.1](./16-07-02-00-new_layer.md#90-01-06-01-a1-01)

[16.7.2.1. 명령 활성화하기(Activating the Command) - 영상 90.1.6.1.a1.1](./16-07-02-01-activating_the_command.md#90-01-06-01-a1-01)
...
#### 그림 90.1.6.1.a11. `이미지 메뉴 바` → `레이어` → `새 레이어`: 떠있는 선택
...
[16.7.2. 새 레이어(New layer) - 그림 90.1.6.1.a11](./16-07-02-00-new_layer.md#90-01-06-01-a11)

<a id="90-01-06-01-a11-01"></a>

#### 영상 90.1.6.1.a11.1. `이미지 메뉴 바` → `레이어` → `새 레이어`: 떠있는 선택 (Windows) (우리말)
...
[16.7.2. 새 레이어(New layer) - 영상 90.1.6.1.a11.1](./16-07-02-00-new_layer.md#90-01-06-01-a11-01)
