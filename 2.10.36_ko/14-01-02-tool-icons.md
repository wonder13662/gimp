...
특정 도구를 자주 사용하지 않는다면, 도구를 보이지 않게 설정할 수 있습니다. 반대로 도구를 자주 사용한다면, 찾기 쉽도록 도구 상자에 보이도록 설정할 수 있습니다. 하지만 어떤 경우라도 [이미지 메뉴 바](./03-02-02-02-image-menu.md)의 `도구` 메뉴 또는 `색` 메뉴를 통해 어떤 도구라도 선택할 수 있습니다.
