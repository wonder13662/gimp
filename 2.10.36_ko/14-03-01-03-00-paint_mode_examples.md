...
다음 예제들은 GIMP(김프)의 칠하기 모드의 몇가지 예제들입니다.
...
[➡️ 다음: 14.3.1.3.1. 분해(Dissolve)](./14-03-01-03-01-dissolve.md)

[⬅️ 이전: 14.3.1.2.15. 증분(Incremental)](./14-03-01-02-15-incremental.md)
