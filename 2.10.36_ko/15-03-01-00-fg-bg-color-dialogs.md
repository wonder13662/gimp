...
`전경/배경색` 대화상자에서 6개의 다른 모드를 사용할 수 있습니다.

- [김프 선택기](./15-03-01-02-01-gimp_selector.md)
- [CMYK](./15-03-01-02-02-cmyk.md)
- [삼각형](./15-03-01-02-04-triangle.md)
- [수채화](./15-03-01-02-03-watercolor.md)
...
`전경/배경색` 대화상자 → `스포이드`를 클릭하고 스크린의 어느 곳이라도 클릭하면 해당 지점의 색을 얻을 수 있습니다.

심지어 GIMP(김프) 바깥의 색을 가져오는 것도 가능합니다.

<a id="90-04-130-a101-01"></a>

#### [그림 90.4.130.a101.1. `전경/배경색` 대화상자 → `스포이드` (Windows) (우리말)](./90-04-0130-fg_bg_color.md#90-04-130-a101-01)
...
## 3. `전경/배경색` 대화상자와 다른 색 대화상자와의 차이점

도구상자의 [색상 영역](./14-01-03-01-color_area.md)의 [전경색](./19-glossaryx-foreground_color.md)과 [배경색](./19-glossaryx-background_color.md)을 클릭해서 나타나는 대화상자는 `전경/배경색` 대화상자와 조금 다릅니다.
...
#### [그림 90.4.130.a111. `전경색 바꾸기` 대화상자(왼쪽)와 `전경/배경색` 대화상자(오른쪽) 비교 (Windows) (우리말)](./90-04-0130-fg_bg_color.md#90-04-130-a111)
...
## 4. 마지막으로 사용했던 색 저장목록
`전경/배경색` 대화상자의 아래쪽에 마지막으로 사용했던 12개의 색을 버튼으로 보여줍니다.

색 버튼을 클릭해서 [전경색](./19-glossaryx-foreground_color.md)또는 [배경색](./19-glossaryx-background_color.md)에 색을 설정할 수 있습니다.

<a id="90-04-130-a101-02"></a>

#### [그림 90.4.130.a101.2. `전경/배경색` 대화상자 → `마지막으로 사용했던 색 저장목록` (Windows) (우리말)](./90-04-0130-fg_bg_color.md#90-04-130-a101-02)
...
#### [영상 90.4.130.a101.2.1. `전경/배경색` 대화상자 → `마지막으로 사용했던 색 저장목록` (Windows) (우리말)](./90-04-0130-fg_bg_color.md#90-04-130-a101-02-01)
