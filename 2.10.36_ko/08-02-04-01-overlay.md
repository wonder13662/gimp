...
`덧씌우기(Overlay)` 모드는 밝은 픽셀은 더 밝게, 어두운 픽셀은 더 어둡게 만들어 줍니다. `덧씌우기(Overlay)` 모드는 [곱하기(Multiply)](./08-02-03-03-00-multiply.md) 모드와 [화면(Screen)](./08-02-02-03-00-screen.md) 모드를 합친 것입니다.
