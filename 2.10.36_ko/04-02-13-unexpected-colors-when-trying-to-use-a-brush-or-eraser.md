...
<a id="04-02-13-s2-01"></a>

### 2-1. 레이어 마스크
작업중인 레이어의 [레이어 마스크](./15-02-01-00-layers-dialog.md)에 칠하고 있는 것은 아닌지 확인해보세요. 그렇다면, 레이어가 아닌 레이어 마스크를 대상으로 칠하고 있는 것입니다. 이 경우, 레이어의 레이어 마스크가 아닌 활성 채색 영역을 클릭해서 레이어에 칠할 수 있도록 해줍니다.

<a id="90-04-03-13-a11"></a>

#### [영상 90.4.3.13.a11. 레이어 마스크에 붓 또는 지우개를 사용](./90-04-0003-013-layer_mask.md#90-04-03-13-a11)
...
<a id="04-02-13-s2-02"></a>

### 2-2. 채널
[레이어](./19-glossaryx-layer.md) 대신 [채널](./19-glossaryx-channel.md)에 칠하고 있을 수도 있습니다. 이 경우에는 레이어 대화상자에서 레이어를 클릭해서 활성화해줍니다.

<a id="90-04-04-a101"></a>

#### [영상 90.4.4.a101. 채널에 붓 또는 지우개를 사용](./90-04-0004-channels.md#90-04-04-a101)
