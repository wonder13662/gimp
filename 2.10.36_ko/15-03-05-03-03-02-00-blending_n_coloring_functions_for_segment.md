# 15.3.5.3.3.2. 그라디언트 구획의 색을 섞거나 색칠하기(Blending and coloring functions for segment)

<a id="90-04-139-a142"></a>

#### [그림 90.4.139.a142. `그라디언트 편집기` 대화상자 → `탭 메뉴` → `그라디언트 편집기 메뉴` → `그라디언트 구획의 색을 섞거나 색칠하기` (Windows) (우리말)](./90-04-0139-gradient_editor.md#90-04-139-a142)
