...
상호작용(Interactive) 모드에서만 유용합니다. 

[13.3.4.8.8. SF-FILENAME](./13-03-04-08-08-sf_filename.md)와 비슷합니다. 

하지만 파일이 아닌 디렉토리를 선택할 수 있는 위젯을 만듭니다.

스크립트가 실행되어서 리턴받는 값은 문자열로 된 폴더의 경로입니다. 

아래 예시에서 처음에 선택된 폴더의 경로는 "/var/tmp/"입니다.
