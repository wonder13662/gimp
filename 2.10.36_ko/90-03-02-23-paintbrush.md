...
[7.10.1. 그라디언트로 칠하기(Painting with a grandient) - 영상 90.3.2.23.a112](./07-10-01-painting_with_a_gradient.md#90-03-02-23-a112)
...
[8.2. 레이어 모드 - 그림 90.3.2.23.a115](./08-02-00-layer_modes.md#90-03-02-23-a115)
...
#### 영상 90.3.2.23.a117.2.1.5.1. `도구 옵션` → `그리기 붓` → `붓` → `붓 대화상자` → `아래쪽 버튼` → `붓 선택 영역 대화상자 열기` (Windows) (우리말)
