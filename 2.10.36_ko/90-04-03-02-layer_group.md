...
[8.5.1. 레이어 그룹 만들기(Create a Layer Group) - 그림 90.4.3.2.a11](./08-05-layer-groupsx-01-create_a_layer_group.md#90-04-03-02-a11)

[8.5.8. 레이어 그룹 끼워 넣기(Embed Layer Groups) - 그림 90.4.3.2.a11](./08-05-layer-groupsx-08-embed_layer_groups.md#90-04-03-02-a11)
...
[8.5.1. 레이어 그룹 만들기(Create a Layer Group) - 영상 90.4.3.2.a21](./08-05-layer-groupsx-01-create_a_layer_group.md#90-04-03-02-a21)
...
[8.5.2. 레이어 그룹에 레이어 넣기(Adding Layers to a Layer Group) - 영상 90.4.3.2.a31](./08-05-layer-groupsx-02-adding_layers_to_a_layer_group.md#90-04-03-02-a31)

[8.5.8. 레이어 그룹 끼워 넣기(Embed Layer Groups) - 영상 90.4.3.2.a31](./08-05-layer-groupsx-08-embed_layer_groups.md#90-04-03-02-a31)
...
[90.5.9. 상태 표시 영역 (Status Area) - 영상 90.4.3.2.a51](./90-05-09-status_area.md#90-04-03-02-a51)
...
[8.5.1. 레이어 그룹 만들기(Create a Layer Group) - 영상 90.4.3.2.a71](./08-05-layer-groupsx-01-create_a_layer_group.md#90-04-03-02-a71)
...
[8.5.1. 레이어 그룹 만들기(Create a Layer Group) - 영상 90.4.3.2.a81](./08-05-layer-groupsx-01-create_a_layer_group.md#90-04-03-02-a81)
...
[8.5.1. 레이어 그룹 만들기(Create a Layer Group) - 영상 90.4.3.2.a91](./08-05-layer-groupsx-01-create_a_layer_group.md#90-04-03-02-a91)
...
[8.5.1. 레이어 그룹 만들기(Create a Layer Group) - 영상 90.4.3.2.a101](./08-05-layer-groupsx-01-create_a_layer_group.md#90-04-03-02-a101)
...
[8.5.1. 레이어 그룹 만들기(Create a Layer Group) - 영상 90.4.3.2.a111](./08-05-layer-groupsx-01-create_a_layer_group.md#90-04-03-02-a111)

[8.5.4. 레이어 그룹 올리기/내리기(Raise and Lower Layer Groups) - 영상 90.4.3.2.a111](./08-05-layer-groupsx-04-raise_n_lower_layer_groups.md#90-04-03-02-a111)
...
[8.5.4. 레이어 그룹 올리기/내리기(Raise and Lower Layer Groups) - 영상 90.4.3.2.a121](./08-05-layer-groupsx-04-raise_n_lower_layer_groups.md#90-04-03-02-a121)
...
[8.5.2. 레이어 그룹에 레이어 넣기(Adding Layers to a Layer Group) - 그림 90.4.3.2.a131](./08-05-layer-groupsx-02-adding_layers_to_a_layer_group.md#90-04-03-02-a131)
...
[8.5.2. 레이어 그룹에 레이어 넣기(Adding Layers to a Layer Group) - 그림 90.4.3.2.a141](./08-05-layer-groupsx-02-adding_layers_to_a_layer_group.md#90-04-03-02-a141)
...
[8.5.2. 레이어 그룹에 레이어 넣기(Adding Layers to a Layer Group) - 그림 90.4.3.2.a151](./08-05-layer-groupsx-02-adding_layers_to_a_layer_group.md#90-04-03-02-a151)
...
[8.5.3. 레이어 그룹 보기(Visibility) - 그림 90.4.3.2.a161](./08-05-layer-groupsx-03-visibility.md#90-04-03-02-a161)
...
[8.5.9. 레이어 모드와 그룹(Layer Modes and Groups) - 영상 90.4.3.2.a171](./08-05-layer-groupsx-09-layer_modes_n_groups.md#90-04-03-02-a171)
...
[8.5.9. 레이어 모드와 그룹(Layer Modes and Groups) - 영상 90.4.3.2.a172](./08-05-layer-groupsx-09-layer_modes_n_groups.md#90-04-03-02-a172)
...
[8.5.10. 불투명도(Opacity) - 영상 90.4.3.2.a181](./08-05-layer-groupsx-10-opacity.md#90-04-03-02-a181)
...
[8.5.11. 레이어 그룹 마스크(Layer Group Mask) - 영상 90.4.3.2.a191](./08-05-layer-groupsx-11-layer_mask.md#90-04-03-02-a191)
...
[8.5.11. 레이어 그룹 마스크(Layer Group Mask) - 영상 90.4.3.2.a192](./08-05-layer-groupsx-11-layer_mask.md#90-04-03-02-a192)
...
[8.5.13. 레이어 미리보기(Layer preview) - 영상 90.4.3.2.a201](./08-05-layer-groupsx-13-layer_preview.md#90-04-03-02-a201)

***

## 다른 페이지로 가기

[➡️ 다음: 90.4.3.3. 떠있는 선택(Floating selection)](./90-04-03-03-floating_selection.md)

[⬅️ 이전: 90.4.3.1. 레이어 대화상자의 컨텍스트 메뉴](./90-04-03-01-00-context_menu.md)
