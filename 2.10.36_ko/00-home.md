...
[2.1.1. GIMP(김프)가 실행가능한 플랫폼들(Known Platforms)](./02-01-01-known_platforms.md)

[2.1.2. 언어 설정(Language)](./02-01-02-00-language.md)

[2.1.2.1. 여러 개의 언어 설정으로 다른 언어의 GIMP(김프) 띄우기](./02-01-02-01-multiple-instances.md)

[2.1.3. 커맨드 라인 실행 옵션들(Command line arguments)](./02-01-03-command_line_arguments.md)

[2.2. 설정 폴더들](./02-02-configuration-folders.md)

[3. GIMP(김프)의 첫번째 단계](./03-00-first-step-with-gimp.md)

[3.1. GIMP(김프)의 기본 개념들](./03-01-basic-concepts.md)
...
[4.2.3. 선택영역 바깥쪽에서 작업을 하려는 경우](./04-02-03-you-are-acting-outside-the-selection.md)
...
[4.2.6. 레이어 바깥쪽에서 작업을 하려는 경우](./04-02-06-you-are-trying-to-act-outside-the-layer.md)
...
[4.2.13. 붓 또는 지우개를 사용하면 이상한 색이 나옵니다](./04-02-13-unexpected-colors-when-trying-to-use-a-brush-or-eraser.md)

[4.2.14. 잘라내기 도구로 잘라낸 뒤에 빈 공간이 생깁니다](./04-02-14-the-crop-tool-leaves-an-empty-area-after-cropping.md)
...
[4.3.1. 모든 도구창이 사라졌습니다](./04-03-01-all-tool-windows-are-missing.md)

[4.3.2. 도구 옵션 대화상자가 사라졌습니다](./04-03-02-tool-options-dialog-is-missing.md)
...
[4.4.1. jpeg 이미지로 내보냈더니 투명 부분이 흰색 또는 검은색으로 바뀌었습니다](./04-04-01-i-am-exporting-to-a-jpeg-image-and-my-transparent-area-turned-white-or-black.md)
...
[7.2. 선택 만들기와 사용하기](./07-02-00-creating-and-using-selections.md)
...
[7.8. GIH 대화상자](./07-08-00-the-gih-dialog-box.md)
...
[8.5. 레이어 그룹](./08-05-00-layer-groups.md)

[8.5.1. 레이어 그룹 만들기(Create a Layer Group)](./08-05-01-create_a_layer_group.md)

[8.5.2. 레이어 그룹에 레이어 넣기(Adding Layers to a Layer Group)](./08-05-02-adding_layers_to_a_layer_group.md)

[8.5.3. 레이어 그룹 보기(Visibility)](./08-05-03-visibility.md)

[8.5.4. 레이어 그룹 올리기/내리기(Raise and Lower Layer Groups)](./08-05-04-raise_n_lower_layer_groups.md)

[8.5.5. 레이어 그룹 복사하기(Duplicate a Layer Group)](./08-05-05-duplicate_a_layer_group.md)

[8.5.6. 다른 이미지로 레이어 그룹 옮기기(Move Layer Groups)](./08-05-06-move_layer_groups.md)

[8.5.7. 레이어 그룹 지우기(Delete a Layer Groups)](./08-05-07-delete_a_layer_group.md)

[8.5.8. 레이어 그룹 끼워 넣기(Embed Layer Groups)](./08-05-08-embed_layer_groups.md)

[8.5.9. 레이어 모드와 그룹(Layer Modes and Groups)](./08-05-09-layer_modes_n_groups.md)
...
[10.1.2.1. 이미지 회전시키기](./10-01-02-01-rotating_an_image.md)

[10.1.2.2. 이미지 잘라내기](./10-01-02-02-cropping.md)

[10.1.3. 색상 보정](./10-01-03-00-improving_colors.md)

[10.1.3.1. 자동화 도구](./10-01-03-01-automated_tools.md)

[10.1.3.2. 노출 문제](./10-01-03-02-00-exposure_problems.md)
...
[10.1.3.3. 색조 및 채도 조정](./10-01-03-03-adjusting_hue_and_saturation.md)

[10.1.4. 선명도 조절하기(Adjust Sharpness)](./10-01-04-00-adjusting_sharpness.md)

[10.1.4.1. 선명하게 하기(Unblurring)](./10-01-04-01-unblurring.md)

[10.1.4.2. 거친 정도 줄이기(Reducing Graininess)](./10-01-04-02-reducing_graininess.md)
...
[12.6. 초기 화면 변경하기(Customize splash-screen)](./12-06-customize-splash-screen.md)

[13. 스크립팅(Scripting)](./13-00-scripting.md)

[13.1. 플러그인(Plugins)](./13-01-00-plugins.md)

[13.1.1. 소개(Introduction)](./13-01-01-introduction.md)
...
[14.1.1. 소개(Introduction)](./14-01-01-introduction.md)

[14.1.2. 도구 아이콘(Tool icons)](./14-01-02-tool-icons.md)
...
[14.2. 선택 도구(Selection tools)](./14-02-00-selection-tools.md)
...
[14.2.8. 전경 선택(Foreground select)](./14-02-08-00-foreground-select.md)
...
[14.4.1. 일반적인 특징(Common features)](./14-04-01-00-common-features.md)

[14.4.1.1. 도구 옵션(Tool Options)](./14-04-01-01-00-tool_options.md)

[14.4.1.1.1. 변형(Transform)](./14-04-01-01-01-transform.md)

[14.4.1.1.2. 방향(Direction)](./14-04-01-01-02-direction.md)
...
[15.1. 대화상자 소개(Dialog introduction)](./15-01-dialog-introduction.md)
...
[15.2.1.2.1. 개요(Overview)](./15-02-01-02-01-overview.md)
...
[15.3. 이미지 콘텐츠 관련 대화상자(Image content related dialogs)](./15-03-00-image-content-related-dialogs.md)
...
[15.4.3. 문서 이력 대화상자(Document history dialog)](./15-04-03-00-document-history-dialog.md)
...
[15.4.4. 양식 대화상자(Templates dialog)](./15-04-04-00-templates-dialog.md)
...
[15.5.2.2. 도구 프리셋 편집기 대화상자 사용하기(Using the Tool Preset Editor)](./15-05-02-02-00-using_the_tool_preset_editor.md)
...
[15.5.2.2.4.1. 도구 프리셋 저장하기(Save Tool Preset)](./15-05-02-02-04-01-save_tool_preset.md)
...
[15.5.5. 상황판(Dashboard)](./15-05-05-00-dashboard.md)
...
[16.1. 메뉴 소개(Introduction to menus)](./16-01-00-introduction_to_menus.md)
...
[16.3.14. 지우기(Clear)](./16-03-14-00-clear.md)
...
[16.5.26. 스크롤 막대 표시(Show Scrollbars)](./16-05-26-show_scrollbars.md)

[16.5.27. 상태표시줄 보이기(Show statusbar)](./16-05-27-show-statusbar.md)

[16.6. 이미지 메뉴(The "Image" menu)](./16-06-00-the-image-menu.md)
...
[16.8.3. 색 온도(Color temperature)](./16-08-03-00-color-temperature.md)

[16.8.3.1. 개요(Overview)](./16-08-03-01-overview.md)

[16.8.3.2. 필터 활성화하기(Activate the filter)](./16-08-03-02-activate_the_filter.md)

[16.8.3.3. 옵션(Options)](./16-08-03-03-00-options.md)
...
[19. 용어집 - 명도(Brightness)](./19-glossaryx-brightness.md)
...
[19. 용어집 - 색 모델: HSL](./19-glossaryx-color_model_hsl.md)
...
[19. 용어집 - 포락선(envelope, 包絡線)](./19-glossaryx-envelope.md)
...
[19. 용어집 - GIMP(김프)의 자체 sRGB 프로파일(GIMP's built-in sRGB profiles)](./19-glossaryx-gimp_built_in_srgb_profile.md)
...
[19. 용어집 - 색상(Hue)](./19-glossaryx-hue.md)
...
[19. 용어집 - MSR(MultiScale Retinex)](./19-glossaryx-msr.md)

[19. 용어집 - MSRCR(MultiScale Retinex with Color Restoration)](./19-glossaryx-msrcr.md)
...
[19. 용어집 - 정밀도(Precision)](./19-glossaryx-precision.md)
...
[19. 용어집 - 유니코드 제어 문자(Unicode Control Character): LRM(Left-to-Right mark)](./19-glossaryx-unicode_control_character-lrm.md)

[19. 용어집 - 유니코드 제어 문자(Unicode Control Character): LRO(Left-to-right override)](./19-glossaryx-unicode_control_character-lro.md)

[19. 용어집 - 유니코드 제어 문자(Unicode Control Character): PDF(Pop directional formatting)](./19-glossaryx-unicode_control_character-pdf.md)

[19. 용어집 - 유니코드 제어 문자(Unicode Control Character): RLE(Right-to-left embedding)](./19-glossaryx-unicode_control_character-rle.md)

[19. 용어집 - 유니코드 제어 문자(Unicode Control Character): RLM(Right-to-left mark)](./19-glossaryx-unicode_control_character-rlm.md)

[19. 용어집 - 유니코드 제어 문자(Unicode Control Character): RLO(Right-to-left override)](./19-glossaryx-unicode_control_character-rlo.md)

[19. 용어집 - 유니코드 제어 문자(Unicode Control Character): ZWJ(Zero width joiner)](./19-glossaryx-unicode_control_character-zwj.md)

[19. 용어집 - 유니코드 제어 문자(Unicode Control Character): ZWNJ(Zero width non-joiner)](./19-glossaryx-unicode_control_character-zwnj.md)

[19. 용어집 - 유니코드 제어 문자(Unicode Control Character): ZWS(Zero width space)](./19-glossaryx-unicode_control_character-zws.md)

[19. 용어집 - 유니코드 제어 문자(Unicode Control Character)](./19-glossaryx-unicode_control_character.md)
...
[90.1.1.4. 레이어로 열기(Open as Layers)](./90-01-01-04-open_as_layers.md)

[90.1.1.5. 위치 열기(Open Location)](./90-01-01-05-open_location.md)

[90.1.1.6. 최근 연 파일(Open Recent)](./90-01-01-06-open_recent.md)
...
[90.1.1.10. 원래대로(Revert)](./90-01-01-10-revert.md)

[90.1.1.11. 이미지 내보내기(Export)](./90-01-01-11-export.md)

[90.1.1.12. 덮어쓰기(Overwrite)](./90-01-01-12-overwrite.md)

[90.1.1.13. 다른 이름으로 이미지 내보내기(Export as)](./90-01-01-13-export_as.md)

[90.1.1.14. 템플릿 만들기(Create Template)](./90-01-01-14-create_template.md)

[90.1.1.15. 페이지 설정하기(Page Setup)](./90-01-01-15-page_setup.md)

[90.1.1.16. 인쇄(Print)](./90-01-01-16-print.md)

[90.1.1.17. 이메일로 보내기(Send By Email)](./90-01-01-17-send_by_email.md)

[90.1.1.18. 이미지 위치 복사하기(Copy Image Location)](./90-01-01-18-copy_image_location.md)

[90.1.1.19. 파일 관리자에 표시(Show in File Manager)](./90-01-01-19-show_in_file_manager.md)

[90.1.1.20. 이미지 닫기(Close View)](./90-01-01-20-close_view.md)

[90.1.1.21. 모든 이미지 창 닫기(Close All)](./90-01-01-21-close_all.md)
...
[90.1.8.9. 확대/축소(Zoom)](./90-01-08-09-zoom.md)
...
[90.2.3. 이미지 불러오기 및 내보내기 (Image Import & Export)](./90-02-03-image-import-n-export.md)
...
[90.2.6.2. 아이콘 테마 (Icon Theme)](./90-02-06-02-icon-theme.md)
...
[90.2.6.6. 화면 (Display)](./90-02-06-06-display.md)
...
[90.4.216. 라인하르트 2005(라인하르트 2005(Reinhard 2005))](./90-04-0216-reinhard_2005.md)
...
[90.10.65. `이미지 메뉴 바` → `편집` → `지우기`](./90-10-65-00-menu_edit_clear.md)
...
[90.10.69. `이미지 메뉴 바` → `선택` → `무늬로 채우기`](./90-10-69-00-menu_select_all.md)
...
[90.10.91.1.2. 키보드 단축키: `아래쪽 방향키(↓, Down Arrow)`](./90-10-91-01-02-down_arrow.md)
...
[90.10.92.1.2. 키보드 단축키: `fn` + `위쪽 방향키(↑, Up Arrow)`](./90-10-92-01-02-fn_up_arrow.md)
