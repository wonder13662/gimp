...
[3.2.3. 대화상자(Dialog)와 도킹(docking)](./03-02-03-dialogs-and-docking.md)

[3.2.3.1. 대화 상자 위치 변경하기](./03-02-03-dialogs-and-dockingx-01-organizing-dialogs.md)

[3.2.3.2. 탭 메뉴 (Tab Menu)](./03-02-03-dialogs-and-dockingx-02-tab-menu.md)
...
[6.1.1. 이미지 저장/내보내기](./06-01-filesx-01-save_export_images.md)
...
[6.1.2. 파일 형식](./06-01-filesx-02-file_formats.md)
...
[7.1. 선택](./07-01-the-selection.md)

[7.1.1. 페더링](./07-01-the-selectionx-01-feathering.md)

[7.1.2. 부분적으로 투명한 선택 만들기](./07-01-the-selectionx-02-making_a_selection_partially_transparent.md)
...
[8.1.1. 레이어 속성](./08-01-introduction-to-layersx-01-layer_properties.md)
...
[8.5.1. 레이어 그룹 만들기(Create a Layer Group)](./08-05-layer-groupsx-01-create_a_layer_group.md)

[8.5.2. 레이어 그룹에 레이어 넣기(Adding Layers to a Layer Group)](./08-05-layer-groupsx-02-adding_layers_to_a_layer_group.md)

[8.5.3. 레이어 그룹 보기(Visibility)](./08-05-layer-groupsx-03-visibility.md)

[8.5.4. 레이어 그룹 올리기/내리기(Raise and Lower Layer Groups)](./08-05-layer-groupsx-04-raise_n_lower_layer_groups.md)

[8.5.5. 레이어 그룹 복사하기(Duplicate a Layer Group)](./08-05-layer-groupsx-05-duplicate_a_layer_group.md)

[8.5.6. 다른 이미지로 레이어 그룹 옮기기(Move Layer Groups)](./08-05-layer-groupsx-06-move_layer_groups.md)

[8.5.7. 레이어 그룹 지우기(Delete a Layer Groups)](./08-05-layer-groupsx-07-delete_a_layer_group.md)

[8.5.8. 레이어 그룹 끼워 넣기(Embed Layer Groups)](./08-05-layer-groupsx-08-embed_layer_groups.md)

[8.5.9. 레이어 모드와 그룹(Layer Modes and Groups)](./08-05-layer-groupsx-09-layer_modes_n_groups.md)

[8.5.10. 불투명도(Opacity)](./08-05-layer-groupsx-10-opacity.md)

[8.5.11. 레이어 마스크(Layer Mask)](./08-05-layer-groupsx-11-layer_mask.md)

[8.5.12. 레이어 찾기(Finding a layer)](./08-05-layer-groupsx-12-finding_a_layer.md)
...
[10.1. 디지털 카메라로 찍은 사진 편집하기](./10-01-working-with-digital-camera-photos.md)

[10.1.1. 들어가기](./10-01-working-with-digital-camera-photosx-01-introduction.md)

[10.1.2. 구조적 교정](./10-01-working-with-digital-camera-photosx-02-improving_composition.md)
...
[10.1.3.1. 자동화 도구](./10-01-working-with-digital-camera-photosx-03-improving_colorsx-01-automated_tools.md)

[10.1.3.2. 노출 문제](./10-01-working-with-digital-camera-photosx-03-improving_colorsx-02-exposure_problems.md)

[10.1.3.2.1. 명도/대비 도구](./10-01-working-with-digital-camera-photosx-03-improving_colorsx-02-exposure_problemsx-01-brightness_contrast.md)
...
[10.1.3.2.5. 레이어 모드 - 나누기(Divide)](./10-01-working-with-digital-camera-photosx-03-improving_colorsx-02-exposure_problemsx-05-layer_mode_divide.md)

[10.1.3.2.6. 그 외의 레이어 모드](./10-01-working-with-digital-camera-photosx-03-improving_colorsx-02-exposure_problemsx-06-layer_mode_etc.md)
...
[10.1.6. 결과물 저장하기](./10-01-working-with-digital-camera-photosx-06-saving_your_results.md)
...
[90.2.5.1. 기본 격자 (Default Grid)](./90-02-05-default-imagex-01-default-grid.md)

[90.2.6. 인터페이스 (Interface)](./90-02-06-interface.md)

[90.2.6.1. 테마 (Theme)](./90-02-06-interfacex-01-theme.md)

[90.2.6.2. 아이콘 테마 (Icon Theme)](./90-02-06-interfacex-02-icon-theme.md)

[90.2.6.3. 도구상자 (Toolbox)](./90-02-06-interfacex-03-toolbox.md)

[90.2.6.4. 대화상자 기본 (Dialog Defaults)](./90-02-06-interfacex-04-dialog-defaults.md)

[90.2.6.5. 도움말 시스템 (Help System)](./90-02-06-interfacex-05-help-system.md)

[90.2.6.6. 화면 (Display)](./90-02-06-interfacex-06-display.md)

[90.2.6.7. 창 관리 (Window Management)](./90-02-06-interfacex-07-window-management.md)
...
[90.4.1.2. 정렬(Alignment)](./90-04-01-tool_optionsx-02-alignment.md)

[90.4.1.3. 사각 선택(Rectangle Select)](./90-04-01-tool_optionsx-03-rectangle_select.md)

[90.4.1.4. 타원 선택(Ellipse Select)](./90-04-01-tool_optionsx-04-ellipse_select.md)

[90.4.1.5. 자유 선택(Free Select)](./90-04-01-tool_optionsx-05-free_select.md)

[90.4.1.6. 가위 선택(Scissors Select)](./90-04-01-tool_optionsx-06-scissors_select.md)

[90.4.1.7. 전경 선택(Foreground Select)](./90-04-01-tool_optionsx-07-foreground_select.md)

[90.4.1.8. 퍼지 선택(Fuzzy Select)](./90-04-01-tool_optionsx-08-fuzzy_select.md)

[90.4.1.9. 색상으로 선택(Select by color)](./90-04-01-tool_optionsx-09-select_by_color.md)

[90.4.1.10. 잘라내기(Crop)](./90-04-01-tool_optionsx-10-crop.md)

[90.4.1.11. 통합 변형(Unified Transform)](./90-04-01-tool_optionsx-11-unified_transform.md)

[90.4.1.12. 회전(Rotate)](./90-04-01-tool_optionsx-12-rotate.md)

[90.4.1.13. 크기 조정(Scale)](./90-04-01-tool_optionsx-13-scale.md)

[90.4.1.14. 기울이기(Shear)](./90-04-01-tool_optionsx-14-shear.md)

[90.4.1.15. 뒤집기(Flip)](./90-04-01-tool_optionsx-15-flip.md)

[90.4.1.16. 원근법(Perspective)](./90-04-01-tool_optionsx-16-perspective.md)

[90.4.1.17. 3차원 변형(3D Transform)](./90-04-01-tool_optionsx-17-3d_transform.md)

[90.4.1.18. 변형 다루기(Handle Transform)](./90-04-01-tool_optionsx-18-handle_transform.md)

[90.4.1.19. 워프 변형(Warp Transform)](./90-04-01-tool_optionsx-19-warp_transform.md)

[90.4.1.20. 골조 변형(Cage Transform)](./90-04-01-tool_optionsx-20-cage_transform.md)

[90.4.1.21. 영역 채우기(Bucket Fill)](./90-04-01-tool_optionsx-21-bucket_fill.md)

[90.4.1.22. 그라디언트(Gradient)](./90-04-01-tool_optionsx-22-gradient.md)

[90.4.1.23. 그리기 붓(Paintbrush)](./90-04-01-tool_optionsx-23-paintbrush.md)

[90.4.1.24. 연필(Pencil)](./90-04-01-tool_optionsx-24-pencil.md)

[90.4.1.25. 에어브러시(Airbrush)](./90-04-01-tool_optionsx-25-airbrush.md)

[90.4.1.26. 잉크(Ink)](./90-04-01-tool_optionsx-26-ink.md)

[90.4.1.27. MyPaint 붓(MyPaint Brush)](./90-04-01-tool_optionsx-27-mypaint_brush.md)

[90.4.1.28. 지우개(Eraser)](./90-04-01-tool_optionsx-28-eraser.md)

[90.4.1.29. 도장(Clone)](./90-04-01-tool_optionsx-29-clone.md)
...
[90.4.1.33. 흐릿하게/선명하게(Blur/Sharpen)](./90-04-01-tool_optionsx-33-blur_sharpen.md)

[90.4.1.34. 닷지/번(Dodge/Burn)](./90-04-01-tool_optionsx-34-dodge_burn.md)

[90.4.1.35. 경로(Paths)](./90-04-01-tool_optionsx-35-paths.md)

[90.4.1.36. 텍스트(Text)](./90-04-01-tool_optionsx-36-text.md)

[90.4.1.37. 색상 추출(Color Picker)](./90-04-01-tool_optionsx-37-color_picker.md)

[90.4.1.38. 측정(Measure)](./90-04-01-tool_optionsx-38-measure.md)

[90.4.1.39. 확대/축소(Zoom)](./90-04-01-tool_optionsx-39-zoom.md)
