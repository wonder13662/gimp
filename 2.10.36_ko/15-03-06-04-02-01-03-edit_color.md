# 15.3.6.4.2.1.3. 색상 수정(Edit Color)

***

## 다른 페이지로 가기

[➡️ 다음: 15.3.6.4.2.1.4. 전경색으로부터 가져오기(New Color from FG)](./15-03-06-04-02-01-04-new_color_from_fg.md)

[⬅️ 이전: 15.3.6.4.2.1.2. 뒤집기(Revert)](./15-03-06-04-02-01-02-revert.md)
