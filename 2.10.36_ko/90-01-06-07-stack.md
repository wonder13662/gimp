...
#### 그림 90.1.6.7.a111. `이미지 메뉴 바` → `이미지` → `스택`: 하위메뉴 (Windows) (우리말)
...
#### 그림 90.1.6.7.a211. `이미지 메뉴 바` → `이미지` → `스택` → `이전 레이어 선택` (Windows) (우리말)
...
#### 그림 90.1.6.7.a221. `이미지 메뉴 바` → `이미지` → `스택` → `다음 레이어 선택` (Windows) (우리말)
...
#### 그림 90.1.6.7.a231. `이미지 메뉴 바` → `이미지` → `스택` → `맨 위 레이어 선택` (Windows) (우리말)
...
#### 그림 90.1.6.7.a241. `이미지 메뉴 바` → `이미지` → `스택` → `바닥 레이어 선택` (Windows) (우리말)
...
#### 그림 90.1.6.7.a251. `이미지 메뉴 바` → `이미지` → `스택` → `레이어 올리기` (Windows) (우리말)
...
#### 그림 90.1.6.7.a261. `이미지 메뉴 바` → `이미지` → `스택` → `레이어 내리기` (Windows) (우리말)
...
#### 그림 90.1.6.7.a271. `이미지 메뉴 바` → `이미지` → `스택` → `레이어를 꼭대기로` (Windows) (우리말)
...
#### 그림 90.1.6.7.a281. `이미지 메뉴 바` → `이미지` → `스택` → `레이어를 바닥으로` (Windows) (우리말)
...
#### 그림 90.1.6.7.a291. `이미지 메뉴 바` → `이미지` → `스택` → `레이어 순서 뒤집기` (Windows) (우리말)
