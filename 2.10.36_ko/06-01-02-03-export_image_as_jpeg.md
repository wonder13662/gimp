...
#### [그림 90.4.33.a111. '이미지를 JPEG로 내보내기' 대화상자 - 고급 설정 (Windows) (우리말)](./90-04-33-export_image_as_jpeg.md#90-04-33-a111)
![90-04-33-a111](https://github.com/wonder13662/gimp/assets/15767104/670a2bf9-6396-4f11-a566-82d9d27c7cdd)

[다른 운영체제와 언어의 '이미지를 JPEG로 내보내기(Export Image as JPEG)' 대화상자 - 고급 설정 확인하기](./90-04-33-export_image_as_jpeg.md#90-04-33-a112)
...
#### [그림 90.4.33.a141. '이미지를 JPEG로 내보내기' 대화상자 - 화질 (Windows) (우리말)](./90-04-33-export_image_as_jpeg.md#90-04-33-a141)
...
#### [그림 90.4.33.a142. '이미지를 JPEG로 내보내기' 대화상자 - 원본 이미지의 화질 설정값 사용 (Windows) (우리말)](./90-04-33-export_image_as_jpeg.md#90-04-33-a142)
...
#### [그림 90.4.33.a143. '이미지를 JPEG로 내보내기' 대화상자 - 이미지 창에 미리 보기 표시 (Windows) (우리말)](./90-04-33-export_image_as_jpeg.md#90-04-33-a143)
...
#### [그림 90.4.33.a144. '이미지를 JPEG로 내보내기' 대화상자 - 메타데이터 유지하기 (Windows) (우리말)](./90-04-33-export_image_as_jpeg.md#90-04-33-a144)
...
#### [그림 90.4.33.a145. '이미지를 JPEG로 내보내기' 대화상자 - 미리 보기 저장 (Windows) (우리말)](./90-04-33-export_image_as_jpeg.md#90-04-33-a145)
...
#### [그림 90.4.33.a146. '이미지를 JPEG로 내보내기' 대화상자 - 색상 프로필 저장 (Windows) (우리말)](./90-04-33-export_image_as_jpeg.md#90-04-33-a146)
...
#### [그림 90.4.33.a147. '이미지를 JPEG로 내보내기' 대화상자 - 설명 (Windows) (우리말)](./90-04-33-export_image_as_jpeg.md#90-04-33-a147)
...
입력한 설명은 [이미지 메뉴 바](./03-02-04-02-image-menu.md)의 `이미지` → `이미지 성질` → `설명(Comment)`에서 확인할 수 있습니다.

<a id="90-04-33-a148"></a>

#### [그림 90.4.33.a148. '이미지를 JPEG로 내보내기' 대화상자 - 설명 - 이미지 속성에서 확인 (Windows) (우리말)](./90-04-33-export_image_as_jpeg.md#90-04-33-a148)
...
#### [그림 90.4.33.a151. '이미지를 JPEG로 내보내기' 대화상자 → 고급 설정 → 최적화 (Windows) (우리말)](./90-04-33-export_image_as_jpeg.md#90-04-33-a151)
...
#### [그림 90.4.33.a152. '이미지를 JPEG로 내보내기' 대화상자 → 고급 설정 → 부드럽게 (Windows) (우리말)](./90-04-33-export_image_as_jpeg.md#90-04-33-a152)
...
#### [그림 90.4.33.a153. '이미지를 JPEG로 내보내기' 대화상자 → 고급 설정 → 산술 부호화 사용 (Windows) (우리말)](./90-04-33-export_image_as_jpeg.md#90-04-33-a153)
...
#### [그림 90.4.33.a154. '이미지를 JPEG로 내보내기' 대화상자 → 고급 설정 → 재시작 표식 사용 (Windows) (우리말)](./90-04-33-export_image_as_jpeg.md#90-04-33-a154)
...
#### [그림 90.4.33.a155. '이미지를 JPEG로 내보내기' 대화상자 → 고급 설정 → 간격(MCU 행) (Windows) (우리말)](./90-04-33-export_image_as_jpeg.md#90-04-33-a155)
...
#### [그림 90.4.33.a156. '이미지를 JPEG로 내보내기' 대화상자 → 고급 설정 → 점진적으로 표시 (Windows) (우리말)](./90-04-33-export_image_as_jpeg.md#90-04-33-a156)
...
#### [그림 90.4.33.a121. '이미지를 JPEG로 내보내기' 대화상자 → 고급 설정 → 서브샘플링 (Windows) (우리말)](./90-04-33-export_image_as_jpeg.md#90-04-33-a121)
![90-04-33-a121](https://github.com/wonder13662/gimp/assets/15767104/57d939ba-5165-41e1-a80f-700fe6b20e56)

[다른 운영체제와 언어의 '이미지를 JPEG로 내보내기' 대화상자 → 고급 설정 → 서브샘플링 확인하기](./90-04-33-export_image_as_jpeg.md#90-04-33-a122)
...
#### [그림 90.4.33.a131. '이미지를 JPEG로 내보내기' 대화상자 → 고급 설정 → DCT 기법 (Windows) (우리말)](./90-04-33-export_image_as_jpeg.md#90-04-33-a131)
![90-04-33-a131](https://github.com/wonder13662/gimp/assets/15767104/491c73d1-21e0-40bb-91ab-4fc0f20eee84)

[다른 운영체제와 언어의 '이미지를 JPEG로 내보내기' 대화상자 → 고급 설정 → DCT 기법 확인하기](./90-04-33-export_image_as_jpeg.md#90-04-33-a132)
