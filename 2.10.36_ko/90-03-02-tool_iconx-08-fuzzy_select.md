...
# 90.3.2.8. 도구 아이콘(Tool icon) - 퍼지 선택(Fuzzy select)
...
[➡️ 다음: 90.3.2.9. 도구 아이콘(Tool icon) - 색상으로 선택(Select by color)](./90-03-02-tool_iconx-09-select_by_color.md)

[⬅️ 이전: 90.3.2.7. 도구 아이콘(Tool icon) - 전경 선택(Foreground select)](./90-03-02-tool_iconx-07-foreground_select.md)
