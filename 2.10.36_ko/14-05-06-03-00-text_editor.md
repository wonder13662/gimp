...
다른 작업을 한 뒤에, 다시 이 텍스트 레이어를 [캔버스](./19-glossaryx-canvas.md)에서 클릭하면 `김프 텍스트 편집기`가 열리면서 텍스트 수정을 할 수 있습니다.
...
다른 레이어에서도 [캔버스](./19-glossaryx-canvas.md)에서 클릭하면 `김프 텍스트 편집기`가 열리면서 텍스트 수정을 할 수 있습니다.
