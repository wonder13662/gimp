# 3.5.2. 직선그리기 예제들
## 3.5.2.1. 예제 #1 - 그리기 붓과 `Color From Gradient` 사용하기
...
## 3.5.2.2. 예제 #2 - 도장의 '무늬로 칠하기'로 직선 그리기
...
## 3.5.2.3. 예제 #3 - 격자에 문지르기(Smudge) 직선그리기로 효과주기
...
## 3.5.2.4. 예제 #4 - 지우개(Eraser) 직선그리기로 플라즈마 구름 효과를 지우기
...
## 3.5.2.5. 예제 #5 - 닷지/번(Dodge/Burn) 직선그리기로 음영이 있는 사각형 그리기
