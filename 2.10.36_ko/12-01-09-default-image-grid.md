...
이 페이지에서 설정한 것들은 [이미지 메뉴 바](./19-glossaryx-image_menu_bar.md)의 [`이미지` → `격자 설정…`](./16-06-33-00-configure-grid.md)에서 변경할 수 있는데, 이는 현재 이미지에만 적용됩니다. 각 항목에 대한 설명은 [16.6.33. 격자 설정…](./16-06-33-00-configure-grid.md)을 참고해주세요.
