# 15.2.3.4.11. 선택에 추가(Add to Selection)

<a id="90-04-05-a141-08-01-01-03-11"></a>

#### [그림 90.4.5.a141.8.1.1.3.11. `경로` 대화상자 → `컨텍스트 메뉴` → `선택에 추가` (windows) (우리말)](./90-04-0005-paths.md#90-04-05-a141-08-01-01-03-11)
...
`경로` 대화상자 → `컨텍스트 메뉴` → `선택에 추가` 메뉴를 누르면 활성화된 경로가 선택으로 바뀌어 기존의 선택에 추가됩니다.
...
#### [영상 90.4.5.a141.8.1.1.3.11.1. `경로` 대화상자 → `컨텍스트 메뉴` → `선택에 추가` (windows) (우리말)](./90-04-0005-paths.md#90-04-05-a141-08-01-01-03-11-01)
...
[➡️ 다음: 15.2.3.4.12. 선택에서 빼기(Subtract from Selection)](./15-02-03-04-12-subtract_from_selection.md)

[⬅️ 이전: 15.2.3.4.10. 경로를 선택으로(Path to Selection)](./15-02-03-04-10-path_to_selection.md)
