...
#### [그림 90.1.10.2.17.a101. `이미지 메뉴 바` → `창` → `도킹가능한 대화` → `마이페인트 붓` (Windows)](./90-01-10-02-17-mypaint_brushes.md#90-01-10-02-17-a101)
...
#### [영상 90.1.10.2.17.a101.1. `이미지 메뉴 바` → `창` → `도킹가능한 대화` → `마이페인트 붓` (Windows) (우리말)](./90-01-10-02-17-mypaint_brushes.md#90-01-10-02-17-a101-01)
