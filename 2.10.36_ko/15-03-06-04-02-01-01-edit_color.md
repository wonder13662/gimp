# 15.3.6.4.2.1.1. 색 편집(Edit Color)

<a id="90-04-60-a119"></a>

#### [그림 90.4.60.a119. `팔레트 편집기` 대화상자 → `아래쪽 버튼들` → `색 편집` (Windows) (우리말)](./90-04-0060-palette_editor.md#90-04-60-a119)
...
#### [영상 90.4.60.a119.1. `팔레트 편집기` 대화상자 → `아래쪽 버튼들` → `색 편집` (Windows) (우리말)](./90-04-0060-palette_editor.md#90-04-60-a119-01)
...
[➡️ 다음: 15.3.6.4.2.1.2. 전경에서 새 색상(New Color from FG)](./15-03-06-04-02-01-02-new_color_from_fg.md)
