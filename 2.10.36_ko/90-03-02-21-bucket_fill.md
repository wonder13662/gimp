...
[14.3.4.3.3. 채우기 유형(Fill Type) - 영상 90.3.2.21.a6](./14-03-04-03-03-fill_type.md#90-03-02-21-a6)
...
#### 그림 90.3.2.21.a6.3.1. `도구 옵션` → `영역 채우기` → `채우기 유형` → `무늬로 채우기` → `무늬 대화상자` (Windows) (우리말)
...
[15.3.4.1. 무늬 대화상자 활성화하기(Patterns dialog) - 그림 90.3.2.21.a6.3.1](./15-03-04-01-activating_the_dialog.md#90-03-02-21-a6-03-01)

<a id="90-03-02-21-a6-03-01-01"></a>

#### 그림 90.3.2.21.a6.3.1.1. `도구 옵션` → `영역 채우기` → `채우기 유형` → `무늬로 채우기` → `무늬 목록` → `무늬 대화상자 목록` (Windows) (우리말)
<img width="264" height="650" alt="90-03-02-21-a6-03-01-01" src="https://github.com/user-attachments/assets/60048add-6499-4018-b88e-cf4885072049" />

<a id="90-03-02-21-a6-03-01-01-01"></a>

#### 그림 90.3.2.21.a6.3.1.1.1. `도구 옵션` → `영역 채우기` → `채우기 유형` → `무늬로 채우기` → `무늬 목록` → `무늬 대화상자 목록` → `아래쪽 버튼들` (Windows) (우리말)
<img width="264" height="650" alt="90-03-02-21-a6-03-01-01-01" src="https://github.com/user-attachments/assets/d51eb1c0-ec61-4eca-92a5-a06bfa615d45" />

<a id="90-03-02-21-a6-03-01-01-01-01"></a>

#### 그림 90.3.2.21.a6.3.1.1.1.1. `도구 옵션` → `영역 채우기` → `채우기 유형` → `무늬로 채우기` → `무늬 목록` → `무늬 대화상자 목록` → `아래쪽 버튼들` → `더 작은 미리보기` (Windows) (우리말)
...
[14.3.4.3.3. 채우기 유형(Fill Type) - 그림 90.3.2.21.a6.3.1.1.1.1](./14-03-04-03-03-fill_type.md#90-03-02-21-a6-03-01-01-01-01)

<a id="90-03-02-21-a6-03-01-01-01-01-01"></a>

#### 영상 90.3.2.21.a6.3.1.1.1.1.1. `도구 옵션` → `영역 채우기` → `채우기 유형` → `무늬로 채우기` → `무늬 목록` → `무늬 대화상자 목록` → `아래쪽 버튼들` → `더 작은 미리보기` (Windows) (우리말)
...
[14.3.4.3.3. 채우기 유형(Fill Type) - 영상 90.3.2.21.a6.3.1.1.1.1.1](./14-03-04-03-03-fill_type.md#90-03-02-21-a6-03-01-01-01-01-01)

<a id="90-03-02-21-a6-03-01-01-01-02"></a>

#### 그림 90.3.2.21.a6.3.1.1.1.2. `도구 옵션` → `영역 채우기` → `채우기 유형` → `무늬로 채우기` → `무늬 목록` → `무늬 대화상자 목록` → `아래쪽 버튼들` → `더 큰 미리보기` (Windows) (우리말)
...
[14.3.4.3.3. 채우기 유형(Fill Type) - 그림 90.3.2.21.a6.3.1.1.1.2](./14-03-04-03-03-fill_type.md#90-03-02-21-a6-03-01-01-01-02)

<a id="90-03-02-21-a6-03-01-01-01-02-01"></a>

#### 영상 90.3.2.21.a6.3.1.1.1.2.1. `도구 옵션` → `영역 채우기` → `채우기 유형` → `무늬로 채우기` → `무늬 목록` → `무늬 대화상자 목록` → `아래쪽 버튼들` → `더 큰 미리보기` (Windows) (우리말)
...
[14.3.4.3.3. 채우기 유형(Fill Type) - 영상 90.3.2.21.a6.3.1.1.1.2.1](./14-03-04-03-03-fill_type.md#90-03-02-21-a6-03-01-01-01-02-01)

<a id="90-03-02-21-a6-03-01-01-01-03"></a>

#### 그림 90.3.2.21.a6.3.1.1.1.3. `도구 옵션` → `영역 채우기` → `채우기 유형` → `무늬로 채우기` → `무늬 목록` → `무늬 대화상자 목록` → `아래쪽 버튼들` → `목록으로 보기` (Windows) (우리말)
...
[14.3.4.3.3. 채우기 유형(Fill Type) - 그림 90.3.2.21.a6.3.1.1.1.3](./14-03-04-03-03-fill_type.md#90-03-02-21-a6-03-01-01-01-03)

<a id="90-03-02-21-a6-03-01-01-01-03-01"></a>

#### 영상 90.3.2.21.a6.3.1.1.1.3.1. `도구 옵션` → `영역 채우기` → `채우기 유형` → `무늬로 채우기` → `무늬 목록` → `무늬 대화상자 목록` → `아래쪽 버튼들` → `목록으로 보기` (Windows) (우리말)
...
[14.3.4.3.3. 채우기 유형(Fill Type) - 영상 90.3.2.21.a6.3.1.1.1.3.1](./14-03-04-03-03-fill_type.md#90-03-02-21-a6-03-01-01-01-03-01)

<a id="90-03-02-21-a6-03-01-01-01-04"></a>

#### 그림 90.3.2.21.a6.3.1.1.1.4. `도구 옵션` → `영역 채우기` → `채우기 유형` → `무늬로 채우기` → `무늬 목록` → `무늬 대화상자 목록` → `아래쪽 버튼들` → `격자로 보기` (Windows) (우리말)
...
[14.3.4.3.3. 채우기 유형(Fill Type) - 그림 90.3.2.21.a6.3.1.1.1.4](./14-03-04-03-03-fill_type.md#90-03-02-21-a6-03-01-01-01-04)

<a id="90-03-02-21-a6-03-01-01-01-04-01"></a>

#### 영상 90.3.2.21.a6.3.1.1.1.4.1. `도구 옵션` → `영역 채우기` → `채우기 유형` → `무늬로 채우기` → `무늬 목록` → `무늬 대화상자 목록` → `아래쪽 버튼들` → `격자로 보기` (Windows) (우리말)
...
[14.3.4.3.3. 채우기 유형(Fill Type) - 영상 90.3.2.21.a6.3.1.1.1.4.1](./14-03-04-03-03-fill_type.md#90-03-02-21-a6-03-01-01-01-04-01)

<a id="90-03-02-21-a6-03-01-01-01-05"></a>

#### 그림 90.3.2.21.a6.3.1.1.1.5. `도구 옵션` → `영역 채우기` → `채우기 유형` → `무늬로 채우기` → `무늬 목록` → `무늬 대화상자 목록` → `아래쪽 버튼들` → `무늬 대화상자 표시` (Windows) (우리말)
...
[14.3.4.3.3. 채우기 유형(Fill Type) - 그림 90.3.2.21.a6.3.1.1.1.5](./14-03-04-03-03-fill_type.md#90-03-02-21-a6-03-01-01-01-05)

[15.3.4.1. 무늬 대화상자 활성화하기(Patterns dialog) - 그림 90.3.2.21.a6.3.1.1.1.5](./15-03-04-01-activating_the_dialog.md#90-03-02-21-a6-03-01-01-01-05)

<a id="90-03-02-21-a6-03-01-01-01-05-01"></a>

#### 영상 90.3.2.21.a6.3.1.1.1.5.1. `도구 옵션` → `영역 채우기` → `채우기 유형` → `무늬로 채우기` → `무늬 목록` → `무늬 대화상자 목록` → `아래쪽 버튼들` → `무늬 대화상자 표시` (Windows) (우리말)
...
[14.3.4.3.3. 채우기 유형(Fill Type) - 영상 90.3.2.21.a6.3.1.1.1.5.1](./14-03-04-03-03-fill_type.md#90-03-02-21-a6-03-01-01-01-05-01)

[15.3.4.1. 무늬 대화상자 활성화하기(Patterns dialog) - 영상 90.3.2.21.a6.3.1.1.1.5.1](./15-03-04-01-activating_the_dialog.md#90-03-02-21-a6-03-01-01-01-05-01)
...
#### 그림 90.3.2.21.a8.3. `도구 옵션` → `영역 채우기` → `선화 감지` → `소스` (Windows) (우리말)
