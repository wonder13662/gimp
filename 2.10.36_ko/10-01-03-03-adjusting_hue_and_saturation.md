...
만약 [레벨](./16-08-10-00-levels.md) 도구로 보정하기 어렵다면, [색상 균형(Color Balance)](./16-08-02-00-color-balance.md) 도구나 [커브(Curves)](./16-08-11-curves.md) 도구를 사용하면 되지만, 이는 사용하기 훨씬 더 어렵습니다.
