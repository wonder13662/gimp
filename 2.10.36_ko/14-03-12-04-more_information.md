...
2. `도장` 도구를 활성화합니다. [`도구 옵션` → `도장` → `원본` → `이미지`](./14-03-12-03-options.md#14-03-11-03-s16-01)를 선택합니다. 정렬은 [`등록됨(Registered)`](./14-03-12-03-options.md#14-03-11-03-s17-03) 모드를 선택합니다.
...
3. `도장` 도구를 활성화합니다.
4. `도구 옵션` → `도장` → `원본`에서 [이미지(Image)](./14-03-12-03-options.md#14-03-11-03-s16-01)를 선택합니다.
5. `도구 옵션` → `도장` → `정렬`에서 [등록됨(Registered)](./14-03-12-03-options.md#14-03-11-03-s17-03)를 선택합니다.
