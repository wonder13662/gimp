# 15.3.6.4.2.1.4. 전경색으로부터 가져오기(New Color from FG)

***

## 다른 페이지로 가기

[➡️ 다음: 15.3.6.4.2.1.5. 색상 삭제(Delete Color)](./15-03-06-04-02-01-05-delete_color.md)

[⬅️ 이전: 15.3.6.4.2.1.3. 색상 수정(Edit Color)](./15-03-06-04-02-01-03-edit_color.md)
