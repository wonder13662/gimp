# 13.3.4.7. 스크립트의 인자를 등록하기(Registering The Script's Parameters)

***

## 다른 페이지로 가기

[➡️ 다음: 13.3.4.8. Script-Fu 인자(parameter) API(The Script-Fu parameter API)](./13-03-04-08-the_script_fu_parameter_api.md)
