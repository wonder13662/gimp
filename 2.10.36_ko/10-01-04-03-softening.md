...
#### [그림 90.1.9.1.2.a1. `필터` → `흐림처리` → `가우시안 흐림처리...` (Windows)](./90-01-09-filtersx-01-blurx-02-gaussian_blur.md#90-01-09-01-02-a1)
...
[다른 운영체제와 언어의 `필터` → `흐림처리` → `가우시안 흐림처리...` 확인하기](./90-01-09-filtersx-01-blurx-02-gaussian_blur.md#90-01-09-01-02-a2)
