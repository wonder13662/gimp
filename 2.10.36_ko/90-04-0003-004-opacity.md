...
#### 그림 90.4.3.4.a41. `레이어 대화상자` → `레이어 특성` → `불투명도` (Windows) (우리말)
...
[➡️ 다음: 90.4.3.5. 레이어 가시성(Layer visibility) - 레이어의 눈 아이콘(Eye icon)](./90-04-0003-005-visibility.md)

[⬅️ 이전: 90.4.3.3. 떠있는 선택(Floating selection)](./90-04-0003-003-floating_selection.md)
