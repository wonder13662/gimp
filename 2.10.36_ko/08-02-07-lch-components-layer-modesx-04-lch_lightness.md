...
`LCh 밝기(LCh Lightness)` 모드는 [HSV 명도(HSV Value)](./08-02-06-hsv-components-layer-modesx-04-hsv_value.md)와 비슷하게 동작합니다.
...
[➡️ 다음: 8.2.7.5. 휘도(Luminance)](./08-02-07-lch-components-layer-modesx-05-luminance.md)

[⬅️ 이전: 8.2.7.3. LCh Color(LCh Color)](./08-02-07-lch-components-layer-modesx-03-lch_color.md)
