...
이 튜토리얼에서는 `Script-Fu`에서 사용하는 [인터프리터](https://ko.wikipedia.org/wiki/%EC%9D%B8%ED%84%B0%ED%94%84%EB%A6%AC%ED%84%B0) 언어인 `Scheme`의 기본 개념에 대해 소개합니다. 
...
마지막으로 `Script-Fu`의 지식을 한 단계 높여줄 몇가지 도전과제를 알아보겠습니다.
