...
### [Prev: 14.2.3. 타원 선택 도구(Ellipse selection)](./14-02-03-ellipse-selection.md)
### [Next: 14.2.5. 퍼지 선택 (마법 지팡이) - Fuzzy selection (magic wand)](./14-02-05-fuzzy-selection-magic-wand.md)
