...
#### 영상 90.4.23.a121.1. `버퍼` 대화상자 → `탭 메뉴` → `버퍼 메뉴` → `버퍼 붙여넣기` (Windows)
...
[15.4.1.3.2.1. 버퍼 붙여넣기(Paste Buffer) - 영상 90.4.23.a121.1](./15-04-01-03-02-01-paste_buffer.md#90-04-23-a121-01-01)
