...
#### [그림 90.4.3.8.a49. `레이어 대화상자` → `레이어 관리` → `레이어 삭제하기` (Windows) (우리말)](./90-04-03-08-bottom_bar_buttons.md#90-04-03-08-a49)
...
#### [영상 90.4.3.8.a49.1. `레이어 대화상자` → `레이어 관리` → `레이어 삭제하기` (Windows) (우리말)](./90-04-03-08-bottom_bar_buttons.md#90-04-03-08-a49-01)
