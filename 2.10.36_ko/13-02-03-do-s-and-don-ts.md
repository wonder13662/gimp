...
스크립트의 실행 결과를 확인하기 위해서 [이미지 메뉴 바](./03-02-04-02-image-menu.md)의 `편집` → `실행 취소` 메뉴를 클릭해시 이전 상태로 돌려서 확인해 볼 수 있습니다. 스크립트의 결과가 이미지에 영향을 미쳤다면, [`실행취소 이력` 대화상자](./15-02-07-undo-history-dialog.md)에 추가됩니다.
