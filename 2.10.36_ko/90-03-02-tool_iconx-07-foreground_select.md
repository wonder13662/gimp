...
[➡️ 다음: 90.3.2.8. 도구 아이콘(Tool icon) - 퍼지 선택(Fuzzy select)](./90-03-02-tool_iconx-08-fuzzy_select.md)

[⬅️ 이전: 90.3.2.6. 도구 아이콘(Tool icon) - 가위 선택(Scissors select)](./90-03-02-tool_iconx-06-scissors_select.md)
