# 8.5.5. 레이어 그룹 복사하기(Duplicate a Layer Group)
레이어 그룹을 복사할 수 있습니다. 
...
레이어 대화상자에서 오른쪽 클릭으로 컨텍스트 메뉴를 열어 `레이어 복제(Duplicate Layer)` 메뉴를 클릭합니다.

선택된 레이어 그룹을 복사할 수 있습니다.
...
[캔버스](./19-glossaryx-canvas.md)로 레이어 그룹을 옮겨서 레이어 그룹을 복사할 수 있습니다. 

다만, 이 경우에는 선택된 레이어 그룹 안에 복사한 그룹이 추가됩니다. 

레이어 그룹 안에 있는 내용들도 함께 복사됩니다. 아래 영상에서 확인해보세요.
