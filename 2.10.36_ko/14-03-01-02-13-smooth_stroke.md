# 14.3.1.2.13. 부드러운 스트로크(Smooth Stroke)
...
`부드러운 스트로크(Smooth Stroke)` 옵션은 붓 스트로크가 이미지에 그려지는 것에 영향을 미치는 것이 아닌, 붓 스크로크의 형태에 영향을 미칩니다.
...
<a comment="TODO 실제로 무게를 높이면 선이 부드럽게 그려집니다."></a>
