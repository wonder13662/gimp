...
#### 그림 90.4.139.a143.1.1.1. `그라디언트 편집기` 대화상자 → `탭 메뉴` → `그라디언트 편집기 메뉴` → `구획의 혼합 함수` → `옵션 목록` → `선형`: 그라디언트 (Windows) (우리말)
...
#### 그림 90.4.139.a143.1.2.1. `그라디언트 편집기` 대화상자 → `탭 메뉴` → `그라디언트 편집기 메뉴` → `구획의 혼합 함수` → `옵션 목록` → `커브`: 그라디언트 (Windows) (우리말)
...
#### 그림 90.4.139.a143.1.3.1. `그라디언트 편집기` 대화상자 → `탭 메뉴` → `그라디언트 편집기 메뉴` → `구획의 혼합 함수` → `옵션 목록` → `사인 곡선` (Windows) (우리말)
...
#### 그림 90.4.139.a143.1.4.1. `그라디언트 편집기` 대화상자 → `탭 메뉴` → `그라디언트 편집기 메뉴` → `구획의 혼합 함수` → `옵션 목록` → `구형(증가)`: 그라디언트 (Windows) (우리말)
...
#### 그림 90.4.139.a143.1.5.1. `그라디언트 편집기` 대화상자 → `탭 메뉴` → `그라디언트 편집기 메뉴` → `구획의 혼합 함수` → `옵션 목록` → `구형(감소)`: 그라디언트 (Windows) (우리말)
...
[15.3.5.3.3.2.1. 구획의 혼합 함수(Blending Function for Segment) - 그림 90.4.139.a143.1.6.1](./15-03-05-03-03-02-01-blending_function_for_segment.md#90-04-139-a143-01-06-01)
