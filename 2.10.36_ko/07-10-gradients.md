...
그라디언트는 선형적인 순서로 색깔들이 배치된 된 것입니다. 그라디언트는 [그라디언트 도구](./14-03-05-gradient.md) 또는 "그라디언트 영역 채우기(gradient fill tool)"을 사용해 선택 영역을 그라디언트의 색상으로 채웁니다. 선택 영역 안의 그라디언트의 색상을 조정하는 여러가지 방법이 있습니다.
