...
[GIMP의 이미지의 색상 모드 - RGB](./05-01-image-types.md#05-01-s1)

[GIMP의 이미지의 색상 모드 - 그레이스케일(grayscale)](./05-01-image-types.md#05-01-s2)

[GIMP의 이미지의 색상 모드 - 인덱스(indexed)](./05-01-image-types.md#05-01-s3)

[CMY(K)](./05-01-image-types.md#05-01-s4)

[알파 채널](./05-01-image-types.md#05-01-s5)

[이미지 모드의 전환](./05-01-image-types.md#05-01-s6)
