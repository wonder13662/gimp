# 15.2.2.2. 채널 대화상자 사용하기(Using the Channel Dialog)
...
[➡️ 다음: 15.2.2.2.1. 개요(Overview)](./15-02-02-02-01-overview.md)

[⬅️ 이전: 15.2.2.1. 대화상자 활성화하기(Activate the dialog)](./15-02-02-01-activate_the_dialog.md)
...
[원문](https://docs.gimp.org/2.10/ko/gimp-channel-dialog.html#gimp-channel-dialog-using)