...
#### [그림 90.4.5.a141.8.1.1. `경로 대화상자` → `컨텍스트 메뉴` (windows) (우리말)](./90-04-05-paths.md#90-04-05-a141-08-01-01)
...
[다른 운영체제와 언어의 `경로 대화상자` → `컨텍스트 메뉴` 확인하기](./90-04-05-paths.md#90-04-05-a141-08-01-02)
...
#### [영상 90.4.5.a141.8.1.1.1. `경로 대화상자` → `컨텍스트 메뉴`: `경로 대화상자` → `경로 목록`에 오른쪽 클릭 (windows) (우리말)](./90-04-05-paths.md#90-04-05-a141-08-01-01-01)
...
#### [영상 90.4.5.a141.8.1.1.2. `경로 대화상자` → `컨텍스트 메뉴`: `경로 대화상자` → `탭 메뉴` → `경로 메뉴` (windows) (우리말)](./90-04-05-paths.md#90-04-05-a141-08-01-01-02)
