# 15.3.6.4.2.1.5. 색상 삭제(Delete Color)

***

## 다른 페이지로 가기

[➡️ 다음: 15.3.6.4.2.1.6. 축소(Zoom Out)](./15-03-06-04-02-01-06-zoom_out.md)

[⬅️ 이전: 15.3.6.4.2.1.4. 전경색으로부터 가져오기(New Color from FG)](./15-03-06-04-02-01-04-new_color_from_fg.md)
