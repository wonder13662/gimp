...
#### [그림 90.2.4.a13.1. `기본설정` → `도구 옵션` → `그리기 도구 공통 옵션` → `붓`:켜기 (Windows) (우리말)](./90-02-04-tool-options.md#90-02-04-a13-01)
...
#### [그림 90.2.4.a13.2. `기본설정` → `도구 옵션` → `그리기 도구 공통 옵션` → `붓`:끄기 (Windows) (우리말)](./90-02-04-tool-options.md#90-02-04-a13-02)
