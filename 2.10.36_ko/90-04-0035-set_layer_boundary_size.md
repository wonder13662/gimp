# 90.4.35. 레이어 경계 크기 지정(Set Layer Boundary Size)
...
[16.7.51.2.1. 레이어 크기(Layer Size) - 그림 90.4.35.a112](./16-07-51-02-01-layer_size.md#90-04-35-a112)
...
#### 그림 90.4.35.a131. `레이어 경계 크기 지정` 대화상자 → `가운데로 버튼` (Windows) (우리말)
