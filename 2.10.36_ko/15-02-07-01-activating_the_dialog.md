...
#### [그림 90.1.10.2.10.a101. `이미지 메뉴 바` → `창` → `실행취소 이력` (Windows)](./90-01-10-02-10-undo_history.md#90-01-10-02-10-a101)
...
#### [영상 90.1.10.2.10.a101.1. `이미지 메뉴 바` → `창` → `실행취소 이력` (Windows)](./90-01-10-02-10-undo_history.md#90-01-10-02-10-a101-01)
...
#### [영상 90.5.16.1.10.a1.1. `대화상자` → `탭 메뉴` → `탭 추가` → `실행취소 이력` (Windows) (우리말)](./90-05-16-00-tab_menu.md#90-05-16-01-10-a1-01)
