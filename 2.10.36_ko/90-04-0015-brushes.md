...
[15.3.2.2.5.10. 타원형 붓 만들기(Elliptical) - 그림 90.4.15.a313.4.10](./15-03-02-02-05-00-the_brushes_context_menu.md#90-04-15-a313-04-10)
...
#### 그림 90.4.15.a314. `붓` 대화상자: `태그 입력창` (Windows) (우리말)
...
#### 영상 90.4.15.a314.1. `붓` 대화상자: `태그 입력창` (Windows) (우리말)
