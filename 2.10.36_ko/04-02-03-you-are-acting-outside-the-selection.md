...
#### 그림 4.3. '선택' 메뉴를 사용해서 선택 영역 고치기
<img width="480" alt="그림 4.3. '선택' 메뉴를 사용해서 선택 영역 고치기" environment="MacOS:Sonoma 14.2.1 GIMP 2.10.36" src="https://github.com/wonder13662/gimp/assets/15767104/981210d8-919c-47d9-9f54-cf0418f7d7a7">
선택영역 바깥쪽인 경우, 활용할 수 있는 선택 메뉴의 `모두(All)`, `없음(None)`, `반전(Invert)` 메뉴.
...
[다음: 4.2.4. 활성화된 drawable이 보이지 않는 경우](./04-02-04-the-active-drawable-is-not-visible.md)

[이전: 4.2.2. 숨겨진 선택](./04-02-02-the-selection-is-hidden.md)
