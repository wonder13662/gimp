...
### 1-4. 곡선(Curve)
[곡선(Curved segements)](./19-glossaryx-path_curve.md)은 [선분](./19-glossaryx-path_segment.md)을 클릭, 드래그하거나 새로운 [노드](./19-glossaryx-path_node.md)를 추가하고 드래그하면 만들 수 있습니다.
...
#### [영상 90.10.35.3.1.a1. Ctrl(⌘) + Alt(⌥): 클릭한 경로 1개를 이동](./90-10-35-03-01-move_nodes.md#90-10-35-03-01-a1)
...
#### [영상 90.10.35.3.2.a2. Ctrl(⌘) + Alt(⌥): 모든 경로를 이동](./90-10-35-03-01-move_nodes.md#90-10-35-03-02-a2)
...
[핸들](./19-glossaryx-path_handle.md)이 나타나면 클릭, 드래그해서 수정할 수 있습니다. 핸들을 나타나게 하는 방법은 [2-2. 핸들 제어](./14-05-02-03-01-design_mode.md#14-05-02-03-01-s2-02)를 참고해주세요. 핸들을 클릭, 드래그하면 [선분](./19-glossaryx-path_segment.md)을 곡선으로 구부릴 수 있습니다. 
