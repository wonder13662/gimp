...
#### [그림 90.3.2.35.a201.1. `도구 옵션` → `경로` → `편집 모드` → `디자인`: 마우스 포인터 아이콘(제어점 추가)](./90-03-02-35-paths.md#90-03-02-35-a201-01)
...
#### [그림 90.3.2.35.a201.2. `도구 옵션` → `경로` → `편집 모드` → `디자인`: 마우스 포인터 아이콘(새로운 하위 경로 추가)](./90-03-02-35-paths.md#90-03-02-35-a201-02)
