...
활성화된 도구가 그리기 도구(painting tool)이라면, 도구 옵션에 레이어 모드와 비슷하게 모드를 선택할 수 있는 드롭다운 목록이 있습니다. 레이어 모드와 같은 모드를 칠하기에 사용할 수 있습니다. 그리고 그리기 도구만의 추가적인 모드가 있습니다. 상세한 정보는 [14.3.1.3. 칠하기 모드 예제](./14-03-01-03-00-paint_mode_examples.md)와 [14.3.1.2.1. 모드(Mode)](./14-03-01-02-01-mode.md)를 확인해주세요.
