# 90.10.1.7.1. Shift(⇧) + Alt(⌥) + 왼쪽 클릭 + 드래그

<a id="90-10-01-07-01-a1"></a>

#### 영상 90.10.1.7.1.a1. Shift(⇧) + Alt(⌥) + 왼쪽 클릭 + 드래그
...
[⬆️ 위: 90.10.1.7. Shift(⇧) + Alt(⌥):동작 변경키(Key modifiers)](./90-10-01-07-00-key_modifier-shift_alt.md)
