# 15.3.2.2.5.11. 부드러운 외곽의 사각형 붓 만들기(Rectangular Feathered)
...
`붓` 대화상자: `미리보기` → `붓 컨텍스트 메뉴` → `부드러운 외곽의 사각형 붓 만들기` 버튼을 누르면, `부드러운 외곽의 사각형 붓 만들기` 대화상자가 열립니다.

<a id="90-04-136-a101"></a>

#### [그림 90.4.136.a101. `부드러운 외곽의 사각형 붓 만들기` 대화상자 (Windows) (우리말)](./90-04-0136-rectangular_feathered.md#90-04-136-a101)
...
[다른 운영체제와 언어의 `부드러운 외곽의 사각형 붓 만들기` 대화상자 확인하기](./90-04-0136-rectangular_feathered.md#90-04-136-a102)
...
#### [영상 90.4.15.a313.4.11.1. `붓` 대화상자: `미리보기` → `붓 컨텍스트 메뉴` → `부드러운 외곽의 사각형 붓 만들기` (Windows) (우리말)](./90-04-0015-brushes.md#90-04-15-a313-04-11-01)
