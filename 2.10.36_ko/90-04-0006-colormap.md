...
[15.2.4. 색상표 대화상자(Colormap dialog) - 그림 90.4.6.a1](./15-02-04-00-colormap_dialog.md#90-04-06-a1)
...
[15.2.4. 색상표 대화상자(Colormap dialog) - 그림 90.4.6.a2](./15-02-04-00-colormap_dialog.md#90-04-06-a2)
...
[15.2.4.3.1. 색상표의 색 클릭하기(Click on a color entry) - 영상 90.4.6.a13](./15-02-04-03-01-click_on_a_color_entry.md#90-04-06-a13)
...
[15.2.4.3.6. 색 편집(Edit Color) - 그림 90.4.6.a101.3](./15-02-04-03-06-edit_color.md#90-04-06-a101-03)
...
[15.2.4.3.6. 색 편집(Edit Color) - 영상 90.4.6.a101.3.1](./15-02-04-03-06-edit_color.md#90-04-06-a101-03-01)
...
#### 영상 90.4.6.a101.5.1. `색상표 대화상자` → `특정 색상의 모든 픽셀 선택하기` (Windows) (우리말)
...
[15.2.4.3.8. 특정 색상의 모든 픽셀 선택하기(Select All Pixels with this Color) - 영상 90.4.6.a101.4.1](./15-02-04-03-08-select_all_pixels_with_this_color.md#90-04-06-a101-05-01)
...
<img width="177" height="238" alt="90-04-06-a101-06-01-03-02" src="https://github.com/wonder13662/gimp/assets/15767104/2ecf9051-3716-4bc6-acf3-b963b5b93371" />
...
#### 그림 90.4.6.a101.6.1.3.3. `색상표 대화상자` → `컨텍스트 메뉴` → `배경에서 색 추가` (Windows) (우리말)
...
[15.2.4.4.3. 배경에서 색 추가(Add Color from Background) - 그림 90.4.6.a101.6.1.3.3](./15-02-04-04-03-add_color_from_bg.md#90-04-06-a101-06-01-03-03)

<a id="90-04-06-a101-06-01-03-03-01"></a>

#### 영상 90.4.6.a101.6.1.3.3.1. `색상표 대화상자` → `컨텍스트 메뉴` → `배경에서 색 추가` (Windows) (우리말)
...
[15.2.4.4.3. 배경에서 색 추가(Add Color from Background) - 영상 90.4.6.a101.6.1.3.3.1](./15-02-04-04-03-add_color_from_bg.md#90-04-06-a101-06-01-03-03-01)

<a id="90-04-06-a101-06-01-03-04"></a>

#### 그림 90.4.6.a101.6.1.3.4. `색상표 대화상자` → `컨텍스트 메뉴` → `이 색상으로 선택` (Windows) (우리말)
...
[15.2.4.4.4. 이 색상으로 선택(Select this Color) - 그림 90.4.6.a101.6.1.3.4](./15-02-04-04-04-select_this_color.md#90-04-06-a101-06-01-03-04)

<a id="90-04-06-a101-06-01-03-04-01"></a>

#### 영상 90.4.6.a101.6.1.3.4.1. `색상표 대화상자` → `컨텍스트 메뉴` → `이 색상으로 선택` (Windows) (우리말)
...
[15.2.4.4.4. 이 색상으로 선택(Select this Color) - 영상 90.4.6.a101.6.1.3.4.1](./15-02-04-04-04-select_this_color.md#90-04-06-a101-06-01-03-04-01)

<a id="90-04-06-a101-06-01-03-05"></a>

#### 그림 90.4.6.a101.6.1.3.5. `색상표 대화상자` → `컨텍스트 메뉴` → `선택영역에 추가` (Windows) (우리말)
...
[15.2.4.4.5. 선택영역에 추가(Add to Selection) - 그림 90.4.6.a101.6.1.3.5](./15-02-04-04-05-add_to_selection.md#90-04-06-a101-06-01-03-05)

<a id="90-04-06-a101-06-01-03-05-01"></a>

#### 영상 90.4.6.a101.6.1.3.5.1. `색상표 대화상자` → `컨텍스트 메뉴` → `선택영역에 추가` (Windows) (우리말)
...
[15.2.4.4.5. 선택영역에 추가(Add to Selection) - 영상 90.4.6.a101.6.1.3.5.1](./15-02-04-04-05-add_to_selection.md#90-04-06-a101-06-01-03-05-01)

<a id="90-04-06-a101-06-01-03-06"></a>

#### 그림 90.4.6.a101.6.1.3.6. `색상표 대화상자` → `컨텍스트 메뉴` → `선택 영역에서 제외` (Windows) (우리말)
...
[15.2.4.4.6. 선택 영역에서 제외(Subtract from Selection) - 그림 90.4.6.a101.6.1.3.6](./15-02-04-04-06-subtract_from_selection.md#90-04-06-a101-06-01-03-06)

<a id="90-04-06-a101-06-01-03-06-01"></a>

#### 영상 90.4.6.a101.6.1.3.6.1. `색상표 대화상자` → `컨텍스트 메뉴` → `선택 영역에서 제외` (Windows) (우리말)
...
[15.2.4.4.6. 선택 영역에서 제외(Subtract from Selection) - 영상 90.4.6.a101.6.1.3.6.1](./15-02-04-04-06-subtract_from_selection.md#90-04-06-a101-06-01-03-06-01)

<a id="90-04-06-a101-06-01-03-07"></a>

#### 그림 90.4.6.a101.6.1.3.7. `색상표 대화상자` → `컨텍스트 메뉴` → `겹치는 부분 선택` (Windows) (우리말)
...
[15.2.4.4.7. 겹치는 부분 선택(Intersect with Selection) - 그림 90.4.6.a101.6.1.3.7](./15-02-04-04-07-intersect_from_selection.md#90-04-06-a101-06-01-03-07)

<a id="90-04-06-a101-06-01-03-07-01"></a>

#### 그림 90.4.6.a101.6.1.3.7.1. `색상표 대화상자` → `컨텍스트 메뉴` → `겹치는 부분 선택` (Windows) (우리말)
...
[15.2.4.4.7. 겹치는 부분 선택(Intersect with Selection) - 그림 90.4.6.a101.6.1.3.7.1](./15-02-04-04-07-intersect_from_selection.md#90-04-06-a101-06-01-03-07-01)

<a id="90-04-06-a101-06-01-03-08"></a>

#### 그림 90.4.6.a101.6.1.3.8. `색상표 대화상자` → `컨텍스트 메뉴` → `색상표 재배치…` (Windows) (우리말)
...
[15.2.4.4.8. 색상표 재배치(Rearrange Colormap) - 그림 90.4.6.a101.6.1.3.8](./15-02-04-04-08-rearrange_colormap.md#90-04-06-a101-06-01-03-08)

<a id="90-04-06-a101-06-01-03-08-01"></a>

#### 영상 90.4.6.a101.6.1.3.8.1. `색상표 대화상자` → `컨텍스트 메뉴` → `색상표 재배치…` (Windows) (우리말)
...
[15.2.4.4.8. 색상표 재배치(Rearrange Colormap) - 영상 90.4.6.a101.6.1.3.8.1](./15-02-04-04-08-rearrange_colormap.md#90-04-06-a101-06-01-03-08-01)

[16.8.35. 색상표 재배치(Rearrange colormap) - 영상 90.4.6.a101.6.1.3.8.1](./16-08-35-rearrange-colormap.md#90-04-06-a101-06-01-03-08-01)
