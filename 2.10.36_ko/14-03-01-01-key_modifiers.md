...
[연필](./14-03-06-00-pencil.md), [그리기 붓](./14-03-07-00-paintbrush.md), [에어브러시](./14-03-10-00-airbrush.md), [잉크](./14-03-11-00-ink.md)에서 Ctrl(⌘) 키를 누르면, [색상 추출 도구(Color Picker)](./14-05-03-color-picker.md) 모드로 바뀝니다. 이 모드에서 이미지의 픽셀에 클릭하면, GIMP(김프)의 전경색이 활성화된 레이어의 클릭한 지점의 색상으로 설정됩니다.
