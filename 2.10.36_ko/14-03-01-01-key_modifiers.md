...
#### [영상 90.10.a161.1. 칠하기 도구 - Ctrl(⌘) 키](./90-10-00-keyboard_shortcut.md#90-10-a161-01)
...
#### [영상 90.10.a161.2. 칠하기 도구:지우개 - Ctrl(⌘) 키](./90-10-00-keyboard_shortcut.md#90-10-a161-02)
...
#### [영상 90.10.a161.3. 칠하기 도구:도장 - Ctrl(⌘) 키](./90-10-00-keyboard_shortcut.md#90-10-a161-03)
...
#### [영상 90.10.a161.4. 칠하기 도구:`흐릿하게/선명하게` - Ctrl(⌘) 키](./90-10-00-keyboard_shortcut.md#90-10-a161-04)
...
### 1-4. `닷지/번`의 모드 전환
for the Dodge/Burn tool, it switches between dodging and burning.
`닷지/번` 도구에서 Ctrl(⌘) 키를 누르면 `번` 모드로 바뀝니다. Ctrl(⌘) 키를 떼면 다시 `닷지` 모드로 돌아갑니다.

<a id="90-10-a161-05"></a>

#### [영상 90.10.a161.5. 칠하기 도구:`닷지/번` - Ctrl(⌘) 키](./90-10-00-keyboard_shortcut.md#90-10-a161-05)
...
## 2. Shift(⇧) - 직선 그리기
Shift(⇧) 키를 누르고 있으면, 대부분의 칠하기 도구에서 `직선 모드`로 바뀝니다.

칠하기 도구에서 직선을 그리려면, 시작점을 클릭합니다. 그리고 Shift(⇧) 키를 누릅니다. Shift(⇧) 키를 계속 누르고 있는 동안에는 시작점과 현재 마우스 포인터의 위치와 연결된 가는 선을 볼 수 있습니다. 
...
## 3. Ctrl(⌘) + Shift(⇧)
Ctrl(⌘)키와 Shift(⇧) 키를 함께 누르고 있으면 칠하기 도구에서 `제한된 직선 모드`가 됩니다. `제한된 직선 모드`는 `직선 모드`와 비슷한 효과를 냅니다. 하지만 `제한된 직선 모드`는 직선의 방향이 15도씩만 회전할 수 있도록 강제된 것이 다릅니다 `제한된 직선 모드`로 완전한 수평, 수직, 대각선을 그릴 수 있습니다.

<a id="90-10-a172-01"></a>

#### [영상 90.10.a172.1. `도구상자` → `칠하기 붓` + Ctrl(⌘) + Shift(⇧): 직선그리기](./90-10-00-keyboard_shortcut.md#90-10-a172-01)
