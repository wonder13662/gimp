...
#### [그림 90.1.6.7.a211. `이미지 메뉴 바` → `이미지` → `스택` → `이전 레이어 선택` (Windows) (우리말)](./90-01-06-07-stack.md#90-01-06-07-a211)
...
## 2. Windows 환경에서 숫자키패드의 PageUp은 동작하지 않습니다
Windows 환경에서 숫자키패드의 PageUp은 동작하지 않습니다.

하지만 숫자키패드의 왼쪽의 여섯 개의 키가 모여있는 그룹의 PageUp은 동작합니다.
