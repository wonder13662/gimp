...
#### [그림 90.4.1.3.a110. `도구 옵션` → `사각 선택` → `모드`](./90-04-0001-003-rectangle_select.md#90-04-01-03-a110)
...
#### [그림 90.4.1.3.a101. `도구 옵션` → `사각 선택` → `가장자리 페더 `(windows) (우리말)](./90-04-0001-003-rectangle_select.md#90-04-01-03-a101)
