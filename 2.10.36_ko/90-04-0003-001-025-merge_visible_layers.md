...
[7.8.2.2. 3차원 이미지 호스(A three dimension image hose) - 그림 90.4.3.1.25.a11](./07-08-02-02-three_dimension_image_hose.md#90-04-03-01-25-a11)

***

## 다른 페이지로 가기

[➡️ 다음: 90.4.3.1.26. 이미지 평탄화(Flatten Image)](./90-04-0003-001-026-flatten_image.md)

[⬅️ 이전: 90.4.3.1.24. 알파를 선택 영역으로(Alpha to Selection)](./90-04-0003-001-024-alpha_to_selection.md)
