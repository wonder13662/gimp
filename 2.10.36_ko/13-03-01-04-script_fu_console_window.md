...
창의 아래쪽의 입력창에 간단한 `Scheme` 명령을 입력하여 결과를 바로 확인할 수 있습니다.
...
#### [영상 90.4.97.a111. 계산 과정](./90-04-0097-script_fu_console.md#90-04-97-a111)
...
이 계산식에 1개의 숫자를 더 추가하고 싶다면 어떻게 해야 할까요? 

`+` 함수는 2개 이상의 인수(argument)를 받을 수 있습니다.
...
#### [영상 90.4.97.a112. 계산 과정](./90-04-0097-script_fu_console.md#90-04-97-a112)
