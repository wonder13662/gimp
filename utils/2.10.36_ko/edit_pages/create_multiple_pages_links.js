...
const doAsyncJob = async () => {
  try {
    // 1-1. 시작 페이지 이름
    const head = '16-06-28-guides.md'
    // const head = '90-04-0188-gimp_message_execution_error_for_align_visible_layers.md'
    ...
    // 1-2. 종료 페이지 이름
    const tail = '16-06-30-new-guide-by-percent.md'
